(function (root, factory) {
  ...
  var UShortArray_init = Kotlin.kotlin.UShortArray_init_za3lpa$;
  ...
  var UByteArray_init_0 = Kotlin.kotlin.UByteArray;
  var UShortArray_init_0 = Kotlin.kotlin.UShortArray;
  var UIntArray_init_0 = Kotlin.kotlin.UIntArray;
  var ULongArray_init_0 = Kotlin.kotlin.ULongArray;
  ...
  function MetaSerializable() {
  }
  MetaSerializable.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'MetaSerializable',
    interfaces: [Annotation]
  };
  ...
  ContextualSerializer.prototype.deserialize_bq71mq$ = function (decoder) {
    return decoder.decodeSerializableValue_2crrky$(this.serializer_0(decoder.serializersModule));
  };
  ...
  function serialDescriptor_0(type) {
    return serializer_16(type).descriptor;
  }
  ...
  ClassSerialDescriptorBuilder.prototype.element_vxrguq$ = function (elementName, descriptor, annotations, isOptional) {
    ...
    if (!this.uniqueNames_0.add_11rb$(elementName)) {
      var message = "Element with name '" + elementName + "' is already registered in " + this.serialName;
      throw IllegalArgumentException_init(message.toString());
    }
  ...
  AbstractDecoder.prototype.decodeSerializableValue_iv0omg$$default = function (deserializer, previousValue) {
    return this.decodeSerializableValue_2crrky$(deserializer);
  };
  AbstractDecoder.prototype.decodeSerializableValue_iv0omg$ = function (deserializer, previousValue, callback$default) {
    if (previousValue === void 0)
      previousValue = null;
    return callback$default ? callback$default(deserializer, previousValue) : this.decodeSerializableValue_iv0omg$$default(deserializer, previousValue);
  };
  ...
  AbstractDecoder.prototype.decodeSerializableElement_cvqn3c$$default = function (descriptor, index, deserializer, previousValue) {
    return this.decodeSerializableValue_iv0omg$(deserializer, previousValue);
  };
  AbstractDecoder.prototype.decodeNullableSerializableElement_hziakr$$default = function (descriptor, index, deserializer, previousValue) {
    var isNullabilitySupported = deserializer.descriptor.isNullable;
    return isNullabilitySupported || this.decodeNotNullMark() ? this.decodeSerializableValue_iv0omg$(deserializer, previousValue) : this.decodeNull();
  };
  ...
  ChunkedDecoder.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'ChunkedDecoder',
    interfaces: []
  };
  function Decoder() {
  }
  Decoder.prototype.decodeSerializableValue_2crrky$ = function (deserializer) {
    return deserializer.deserialize_bq71mq$(this);
  };
  Decoder.prototype.decodeNullableSerializableValue_h9dkw5$ = function (deserializer) {
    var isNullabilitySupported = deserializer.descriptor.isNullable;
    return isNullabilitySupported || this.decodeNotNullMark() ? this.decodeSerializableValue_2crrky$(deserializer) : this.decodeNull();
  };
  Decoder.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'Decoder',
  ...
  CompositeDecoder.prototype.decodeSerializableElement_cvqn3c$ = function (descriptor, index, deserializer, previousValue, callback$default) {
    if (previousValue === void 0)
      previousValue = null;
    return callback$default ? callback$default(descriptor, index, deserializer, previousValue) : this.decodeSerializableElement_cvqn3c$$default(descriptor, index, deserializer, previousValue);
  };
  CompositeDecoder.prototype.decodeNullableSerializableElement_hziakr$ = function (descriptor, index, deserializer, previousValue, callback$default) {
    if (previousValue === void 0)
      previousValue = null;
    return callback$default ? callback$default(descriptor, index, deserializer, previousValue) : this.decodeNullableSerializableElement_hziakr$$default(descriptor, index, deserializer, previousValue);
  };
      ...
      mainLoop: while (true) {
        ...
        switch (index) {
          ...
          case 1:
            ...
            value = $receiver.decodeSerializableElement_cvqn3c$(this$AbstractPolymorphicSerializer.descriptor, index, serializer);
            break;
          default:
  ...
  AbstractPolymorphicSerializer.prototype.decodeSequentially_j3xsyv$_0 = function (compositeDecoder) {
    ...
    return compositeDecoder.decodeSerializableElement_cvqn3c$(this.descriptor, 1, serializer);
  };
  ...
  function throwSubtypeNotRegistered(subClassName, baseClass) {
    ...
    throw SerializationException_init_0(subClassName == null ? 'Class discriminator was missing and no default polymorphic serializers were registered ' + scope : "Class '" + toString(subClassName) + "' is not registered for polymorphic serialization " + scope + '.' + '\n' + ("To be registered automatically, class '" + toString(subClassName) + "' has to be '@Serializable', and the base class '" + toString(baseClass.simpleName) + "' has to be sealed and '@Serializable'." + '\n') + ("Alternatively, register the serializer for '" + toString(subClassName) + "' explicitly in a corresponding SerializersModule."));
  }
  ...
  Object.defineProperty(DurationSerializer.prototype, 'descriptor', {
    configurable: true,
    get: function () {
  ...
  DurationSerializer.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'DurationSerializer',
    interfaces: [KSerializer]
  };
  ...
  function NothingSerializer_0() {
    ...
    this.descriptor_libzj4$_0 = NothingSerialDescriptor_getInstance();
  }
  Object.defineProperty(NothingSerializer_0.prototype, 'descriptor', {
    configurable: true,
    get: function () {
      return this.descriptor_libzj4$_0;
    }
  });
  NothingSerializer_0.prototype.serialize_55azsf$ = function (encoder, value) {
    throw SerializationException_init_0("'kotlin.Nothing' cannot be serialized");
  };
  NothingSerializer_0.prototype.deserialize_bq71mq$ = function (decoder) {
    throw SerializationException_init_0("'kotlin.Nothing' does not have instances");
  };
  NothingSerializer_0.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'NothingSerializer',
    interfaces: [KSerializer]
  };
  var NothingSerializer_instance = null;
  ...
  CollectionLikeSerializer.prototype.readElement_8pvye7$$default = function (decoder, index, builder, checkIndex) {
    this.insert_p422l$(builder, index, decoder.decodeSerializableElement_cvqn3c$(this.descriptor, index, this.elementSerializer_0));
  };
  ...
  MapLikeSerializer.prototype.readElement_8pvye7$$default = function (decoder, index, builder, checkIndex) {
    var tmp$, tmp$_0;
    var key = decoder.decodeSerializableElement_cvqn3c$(this.descriptor, index, this.keySerializer);
    if (checkIndex) {
    ...
    if (builder.containsKey_11rb$(key) && !Kotlin.isType(this.valueSerializer.descriptor.kind, PrimitiveKind)) {
      tmp$_0 = decoder.decodeSerializableElement_cvqn3c$(this.descriptor, vIndex, this.valueSerializer, getValue(builder, key));
    } else {
      tmp$_0 = decoder.decodeSerializableElement_cvqn3c$(this.descriptor, vIndex, this.valueSerializer);
    }
    var value = tmp$_0;
  ...
  function createMarkedEnumSerializer(serialName, values, names, annotations) {
    ...
    for (tmp$ = 0; tmp$ !== values.length; ++tmp$) {
      ...
      var tmp$_1, tmp$_2;
      var elementName = (tmp$_1 = getOrNull(names, i)) != null ? tmp$_1 : item.name;
      descriptor.addElement_ivxn3r$(elementName);
      if ((tmp$_2 = getOrNull(annotations, i)) != null) {
        var tmp$_3;
        for (tmp$_3 = 0; tmp$_3 !== tmp$_2.length; ++tmp$_3) {
          var element = tmp$_2[tmp$_3];
          descriptor.pushAnnotation_yj921w$(element);
        }
      }
    }
    return EnumSerializer_init(serialName, values, descriptor);
  }
  function createAnnotatedEnumSerializer(serialName, values, names, entryAnnotations, classAnnotations) {
    var descriptor = new EnumDescriptor(serialName, values.length);
    if (classAnnotations != null) {
      var tmp$;
      for (tmp$ = 0; tmp$ !== classAnnotations.length; ++tmp$) {
        var element = classAnnotations[tmp$];
        descriptor.pushClassAnnotation_yj921w$(element);
      }
    }
    var tmp$_0, tmp$_0_0;
    var index = 0;
    for (tmp$_0 = 0; tmp$_0 !== values.length; ++tmp$_0) {
      var item = values[tmp$_0];
      var i = (tmp$_0_0 = index, index = tmp$_0_0 + 1 | 0, tmp$_0_0);
      var tmp$_1, tmp$_2;
      var elementName = (tmp$_1 = getOrNull(names, i)) != null ? tmp$_1 : item.name;
      descriptor.addElement_ivxn3r$(elementName);
      if ((tmp$_2 = getOrNull(entryAnnotations, i)) != null) {
        var tmp$_3;
        for (tmp$_3 = 0; tmp$_3 !== tmp$_2.length; ++tmp$_3) {
          var element_0 = tmp$_2[tmp$_3];
          descriptor.pushAnnotation_yj921w$(element_0);
        }
      }
    }
    return EnumSerializer_init(serialName, values, descriptor);
  ...
  function EnumSerializer(serialName, values) {
    ...
    this.overriddenDescriptor_0 = null;
    this.descriptor_ulj9cc$_0 = lazy(EnumSerializer$descriptor$lambda(this, serialName));
  }
  Object.defineProperty(EnumSerializer.prototype, 'descriptor', {
    configurable: true,
    get: function () {
      return this.descriptor_ulj9cc$_0.value;
    }
  });
  EnumSerializer.prototype.createUnmarkedDescriptor_0 = function (serialName) {
    var d = new EnumDescriptor(serialName, this.values_0.length);
    var $receiver = this.values_0;
    var tmp$;
    for (tmp$ = 0; tmp$ !== $receiver.length; ++tmp$) {
      var element = $receiver[tmp$];
      d.addElement_ivxn3r$(element.name);
    }
    return d;
  };
  ...
  function EnumSerializer$descriptor$lambda(this$EnumSerializer, closure$serialName) {
    return function () {
      var tmp$;
      return (tmp$ = this$EnumSerializer.overriddenDescriptor_0) != null ? tmp$ : this$EnumSerializer.createUnmarkedDescriptor_0(closure$serialName);
    };
  }
  ...
  function EnumSerializer_init(serialName, values, descriptor, $this) {
    $this = $this || Object.create(EnumSerializer.prototype);
    EnumSerializer.call($this, serialName, values);
    $this.overriddenDescriptor_0 = descriptor;
    return $this;
  }
  ...
  function NothingSerialDescriptor() {
    ...
    this.kind_euvy30$_0 = StructureKind$OBJECT_getInstance();
    this.serialName_p4df4v$_0 = 'kotlin.Nothing';
  }
  Object.defineProperty(NothingSerialDescriptor.prototype, 'kind', {
    configurable: true,
    get: function () {
      return this.kind_euvy30$_0;
    }
  });
  Object.defineProperty(NothingSerialDescriptor.prototype, 'serialName', {
    configurable: true,
    get: function () {
      return this.serialName_p4df4v$_0;
    }
  });
  Object.defineProperty(NothingSerialDescriptor.prototype, 'elementsCount', {
    configurable: true,
    get: function () {
      return 0;
    }
  });
  NothingSerialDescriptor.prototype.getElementName_za3lpa$ = function (index) {
    return this.error_0();
  };
  NothingSerialDescriptor.prototype.getElementIndex_61zpoe$ = function (name) {
    return this.error_0();
  };
  NothingSerialDescriptor.prototype.isElementOptional_za3lpa$ = function (index) {
    return this.error_0();
  };
  NothingSerialDescriptor.prototype.getElementDescriptor_za3lpa$ = function (index) {
    return this.error_0();
  };
  NothingSerialDescriptor.prototype.getElementAnnotations_za3lpa$ = function (index) {
    return this.error_0();
  };
  ...
  NothingSerialDescriptor.prototype.hashCode = function () {
    return hashCode(this.serialName) + (31 * this.kind.hashCode() | 0) | 0;
  };
  NothingSerialDescriptor.prototype.error_0 = function () {
    throw IllegalStateException_init('Descriptor for type `kotlin.Nothing` does not have elements');
  };
  NothingSerialDescriptor.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'NothingSerialDescriptor',
    interfaces: [SerialDescriptor]
  };
  var NothingSerialDescriptor_instance = null;
  ...
  NullableSerializer.prototype.deserialize_bq71mq$ = function (decoder) {
    return decoder.decodeNotNullMark() ? decoder.decodeSerializableValue_2crrky$(this.serializer_0) : decoder.decodeNull();
  };
  ...
  function serializerNotRegistered($receiver) {
    throw SerializationException_init_0(notRegisteredMessage($receiver));
  }
  function notRegisteredMessage($receiver) {
    var tmp$;
    return notRegisteredMessage_0((tmp$ = $receiver.simpleName) != null ? tmp$ : '<local class name not available>');
  }
  ...
  function kclass($receiver) {
    ...
    if (Kotlin.isType(t, KClass))
      ...
      throw IllegalStateException_init(('Captured type parameter ' + toString(t) + ' from generic non-reified function. ' + ('Such functionality cannot be supported as ' + toString(t) + ' is erased, either specify serializer explicitly or make ') + ('calling function inline with reified ' + toString(t))).toString());
    } else {
  ...
  SerializerCache.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'SerializerCache',
    interfaces: []
  };
  function ParametrizedSerializerCache() {
  }
  ParametrizedSerializerCache.prototype.get_rhihk2$ = function (key, types, callback$default) {
    if (types === void 0)
      types = emptyList();
    return callback$default ? callback$default(key, types) : this.get_rhihk2$$default(key, types);
  };
  ParametrizedSerializerCache.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'ParametrizedSerializerCache',
    interfaces: []
  };
  function throwMissingFieldException(seen, goldenMask, descriptor) {
    ...
    throw MissingFieldException_init(missingFields, descriptor.serialName);
  }
  ...
  function UByteArraySerializer_0() {
    ...
    PrimitiveArraySerializer.call(this, serializer_11(UByte.Companion));
  }
  UByteArraySerializer_0.prototype.collectionSize_wikn$ = function ($receiver) {
    return $receiver.size;
  };
  UByteArraySerializer_0.prototype.toBuilder_wikn$ = function ($receiver) {
    return new UByteArrayBuilder($receiver);
  };
  UByteArraySerializer_0.prototype.empty = function () {
    return UByteArray_init(0);
  };
  UByteArraySerializer_0.prototype.readElement_8pvye7$$default = function (decoder, index, builder, checkIndex) {
    builder.append_o3xyst$(new UByte(decoder.decodeInlineElement_szpzho$(this.descriptor, index).decodeByte()));
  };
  UByteArraySerializer_0.prototype.writeContent_q3xt5$ = function (encoder, content, size) {
    for (var i = 0; i < size; i++) {
      encoder.encodeInlineElement_szpzho$(this.descriptor, i).encodeByte_s8j3t7$(content.get_za3lpa$(i).data);
    }
  };
  UByteArraySerializer_0.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'UByteArraySerializer',
    interfaces: [PrimitiveArraySerializer, KSerializer]
  };
  var UByteArraySerializer_instance = null;
  ...
  function UByteArrayBuilder(bufferWithData) {
    PrimitiveArrayBuilder.call(this);
    this.buffer_0 = bufferWithData;
    this.position_dr41sq$_0 = bufferWithData.size;
    this.ensureCapacity_za3lpa$(10);
  }
  Object.defineProperty(UByteArrayBuilder.prototype, 'position', {
    configurable: true,
    get: function () {
      return this.position_dr41sq$_0;
    },
    set: function (position) {
      this.position_dr41sq$_0 = position;
    }
  });
  UByteArrayBuilder.prototype.ensureCapacity_za3lpa$$default = function (requiredCapacity) {
    if (this.buffer_0.size < requiredCapacity) {
      var $receiver = this.buffer_0;
      var newSize = coerceAtLeast(requiredCapacity, this.buffer_0.size * 2 | 0);
      this.buffer_0 = new UByteArray_init_0(copyOf($receiver.storage, newSize));
    }
  };
  UByteArrayBuilder.prototype.append_o3xyst$ = function (c) {
    var tmp$;
    this.ensureCapacity_za3lpa$();
    this.buffer_0.set_2c6cbe$((tmp$ = this.position, this.position = tmp$ + 1 | 0, tmp$), c);
  };
  UByteArrayBuilder.prototype.build = function () {
    var $receiver = this.buffer_0;
    var newSize = this.position;
    return new UByteArray_init_0(copyOf($receiver.storage, newSize));
  };
  UByteArrayBuilder.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'UByteArrayBuilder',
    interfaces: [PrimitiveArrayBuilder]
  };
  function UShortArraySerializer_0() {
    UShortArraySerializer_instance = this;
    PrimitiveArraySerializer.call(this, serializer_12(UShort.Companion));
  }
  UShortArraySerializer_0.prototype.collectionSize_wikn$ = function ($receiver) {
    return $receiver.size;
  };
  UShortArraySerializer_0.prototype.toBuilder_wikn$ = function ($receiver) {
    return new UShortArrayBuilder($receiver);
  };
  UShortArraySerializer_0.prototype.empty = function () {
    return UShortArray_init(0);
  };
  UShortArraySerializer_0.prototype.readElement_8pvye7$$default = function (decoder, index, builder, checkIndex) {
    builder.append_xoy2x5$(new UShort(decoder.decodeInlineElement_szpzho$(this.descriptor, index).decodeShort()));
  };
  UShortArraySerializer_0.prototype.writeContent_q3xt5$ = function (encoder, content, size) {
    for (var i = 0; i < size; i++) {
      encoder.encodeInlineElement_szpzho$(this.descriptor, i).encodeShort_mq22fl$(content.get_za3lpa$(i).data);
    }
  };
  UShortArraySerializer_0.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'UShortArraySerializer',
    interfaces: [PrimitiveArraySerializer, KSerializer]
  };
  var UShortArraySerializer_instance = null;
  ...
  function UShortArrayBuilder(bufferWithData) {
    PrimitiveArrayBuilder.call(this);
    this.buffer_0 = bufferWithData;
    this.position_26tcvs$_0 = bufferWithData.size;
    this.ensureCapacity_za3lpa$(10);
  }
  Object.defineProperty(UShortArrayBuilder.prototype, 'position', {
    configurable: true,
    get: function () {
      return this.position_26tcvs$_0;
    },
    set: function (position) {
      this.position_26tcvs$_0 = position;
    }
  });
  UShortArrayBuilder.prototype.ensureCapacity_za3lpa$$default = function (requiredCapacity) {
    if (this.buffer_0.size < requiredCapacity) {
      var $receiver = this.buffer_0;
      var newSize = coerceAtLeast(requiredCapacity, this.buffer_0.size * 2 | 0);
      this.buffer_0 = new UShortArray_init_0(copyOf_0($receiver.storage, newSize));
    }
  };
  UShortArrayBuilder.prototype.append_xoy2x5$ = function (c) {
    var tmp$;
    this.ensureCapacity_za3lpa$();
    this.buffer_0.set_1pe3u2$((tmp$ = this.position, this.position = tmp$ + 1 | 0, tmp$), c);
  };
  UShortArrayBuilder.prototype.build = function () {
    var $receiver = this.buffer_0;
    var newSize = this.position;
    return new UShortArray_init_0(copyOf_0($receiver.storage, newSize));
  };
  UShortArrayBuilder.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'UShortArrayBuilder',
    interfaces: [PrimitiveArrayBuilder]
  };
  function UIntArraySerializer_0() {
    UIntArraySerializer_instance = this;
    PrimitiveArraySerializer.call(this, serializer_9(UInt.Companion));
  }
  UIntArraySerializer_0.prototype.collectionSize_wikn$ = function ($receiver) {
    return $receiver.size;
  };
  UIntArraySerializer_0.prototype.toBuilder_wikn$ = function ($receiver) {
    return new UIntArrayBuilder($receiver);
  };
  UIntArraySerializer_0.prototype.empty = function () {
    return UIntArray_init(0);
  };
  UIntArraySerializer_0.prototype.readElement_8pvye7$$default = function (decoder, index, builder, checkIndex) {
    builder.append_8dy4nq$(new UInt(decoder.decodeInlineElement_szpzho$(this.descriptor, index).decodeInt()));
  };
  UIntArraySerializer_0.prototype.writeContent_q3xt5$ = function (encoder, content, size) {
    for (var i = 0; i < size; i++) {
      encoder.encodeInlineElement_szpzho$(this.descriptor, i).encodeInt_za3lpa$(content.get_za3lpa$(i).data);
    }
  };
  UIntArraySerializer_0.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'UIntArraySerializer',
    interfaces: [PrimitiveArraySerializer, KSerializer]
  };
  var UIntArraySerializer_instance = null;
  ...
  function UIntArrayBuilder(bufferWithData) {
    PrimitiveArrayBuilder.call(this);
    this.buffer_0 = bufferWithData;
    this.position_5u7oud$_0 = bufferWithData.size;
    this.ensureCapacity_za3lpa$(10);
  }
  Object.defineProperty(UIntArrayBuilder.prototype, 'position', {
    configurable: true,
    get: function () {
      return this.position_5u7oud$_0;
    },
    set: function (position) {
      this.position_5u7oud$_0 = position;
    }
  });
  UIntArrayBuilder.prototype.ensureCapacity_za3lpa$$default = function (requiredCapacity) {
    if (this.buffer_0.size < requiredCapacity) {
      var $receiver = this.buffer_0;
      var newSize = coerceAtLeast(requiredCapacity, this.buffer_0.size * 2 | 0);
      this.buffer_0 = new UIntArray_init_0(copyOf_1($receiver.storage, newSize));
    }
  };
  UIntArrayBuilder.prototype.append_8dy4nq$ = function (c) {
    var tmp$;
    this.ensureCapacity_za3lpa$();
    this.buffer_0.set_6sqrdv$((tmp$ = this.position, this.position = tmp$ + 1 | 0, tmp$), c);
  };
  UIntArrayBuilder.prototype.build = function () {
    var $receiver = this.buffer_0;
    var newSize = this.position;
    return new UIntArray_init_0(copyOf_1($receiver.storage, newSize));
  };
  UIntArrayBuilder.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'UIntArrayBuilder',
    interfaces: [PrimitiveArrayBuilder]
  };
  function ULongArraySerializer_0() {
    ULongArraySerializer_instance = this;
    PrimitiveArraySerializer.call(this, serializer_10(ULong.Companion));
  }
  ULongArraySerializer_0.prototype.collectionSize_wikn$ = function ($receiver) {
    return $receiver.size;
  };
  ULongArraySerializer_0.prototype.toBuilder_wikn$ = function ($receiver) {
    return new ULongArrayBuilder($receiver);
  };
  ULongArraySerializer_0.prototype.empty = function () {
    return ULongArray_init(0);
  };
  ULongArraySerializer_0.prototype.readElement_8pvye7$$default = function (decoder, index, builder, checkIndex) {
    builder.append_o44541$(new ULong(decoder.decodeInlineElement_szpzho$(this.descriptor, index).decodeLong()));
  };
  ULongArraySerializer_0.prototype.writeContent_q3xt5$ = function (encoder, content, size) {
    for (var i = 0; i < size; i++) {
      encoder.encodeInlineElement_szpzho$(this.descriptor, i).encodeLong_s8cxhz$(content.get_za3lpa$(i).data);
    }
  };
  ULongArraySerializer_0.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'ULongArraySerializer',
    interfaces: [PrimitiveArraySerializer, KSerializer]
  };
  var ULongArraySerializer_instance = null;
  ...
  function ULongArrayBuilder(bufferWithData) {
    PrimitiveArrayBuilder.call(this);
    this.buffer_0 = bufferWithData;
    this.position_rkqpui$_0 = bufferWithData.size;
    this.ensureCapacity_za3lpa$(10);
  }
  Object.defineProperty(ULongArrayBuilder.prototype, 'position', {
    configurable: true,
    get: function () {
      return this.position_rkqpui$_0;
    },
    set: function (position) {
      this.position_rkqpui$_0 = position;
    }
  });
  ULongArrayBuilder.prototype.ensureCapacity_za3lpa$$default = function (requiredCapacity) {
    if (this.buffer_0.size < requiredCapacity) {
      var $receiver = this.buffer_0;
      var newSize = coerceAtLeast(requiredCapacity, this.buffer_0.size * 2 | 0);
      this.buffer_0 = new ULongArray_init_0(copyOf_2($receiver.storage, newSize));
    }
  };
  ULongArrayBuilder.prototype.append_o44541$ = function (c) {
    var tmp$;
    this.ensureCapacity_za3lpa$();
    this.buffer_0.set_2ccimm$((tmp$ = this.position, this.position = tmp$ + 1 | 0, tmp$), c);
  };
  ULongArrayBuilder.prototype.build = function () {
    var $receiver = this.buffer_0;
    var newSize = this.position;
    return new ULongArray_init_0(copyOf_2($receiver.storage, newSize));
  };
  ULongArrayBuilder.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ULongArrayBuilder',
    interfaces: [PrimitiveArrayBuilder]
  };
  ...
  PrimitiveSerialDescriptor_0.prototype.equals = function (other) {
    if (this === other)
      return true;
    if (!Kotlin.isType(other, PrimitiveSerialDescriptor_0))
      return false;
    if (equals(this.serialName, other.serialName) && equals(this.kind, other.kind))
      return true;
    return false;
  };
  ...
  TaggedDecoder.prototype.decodeSerializableValue_iv0omg$ = function (deserializer, previousValue) {
    return this.decodeSerializableValue_2crrky$(deserializer);
  };
  ...
  function TaggedDecoder$decodeSerializableElement$lambda(closure$deserializer, closure$previousValue, this$TaggedDecoder) {
    return function () {
      return this$TaggedDecoder.decodeSerializableValue_iv0omg$(closure$deserializer, closure$previousValue);
    };
  }
  TaggedDecoder.prototype.decodeSerializableElement_cvqn3c$$default = function (descriptor, index, deserializer, previousValue) {
  ...
  function TaggedDecoder$decodeNullableSerializableElement$lambda(this$TaggedDecoder, closure$deserializer, closure$previousValue) {
    return function () {
      return this$TaggedDecoder.decodeNotNullMark() ? this$TaggedDecoder.decodeSerializableValue_iv0omg$(closure$deserializer, closure$previousValue) : this$TaggedDecoder.decodeNull();
    };
  }
  TaggedDecoder.prototype.decodeNullableSerializableElement_hziakr$$default = function (descriptor, index, deserializer, previousValue) {
  ...
  NamedValueDecoder.prototype.elementName_szpzho$ = function (descriptor, index) {
    return descriptor.getElementName_za3lpa$(index);
  };
  ...
  KeyValueSerializer.prototype.deserialize_bq71mq$ = function (decoder) {
    ...
    if (composite.decodeSequentially()) {
      var key = composite.decodeSerializableElement_cvqn3c$(this.descriptor, 0, this.keySerializer_0);
      var value = composite.decodeSerializableElement_cvqn3c$(this.descriptor, 1, this.valueSerializer_0);
    ...
    mainLoop: while (true) {
      ...
      switch (idx) {
        case -1:
          break mainLoop;
        case 0:
          key_0 = composite.decodeSerializableElement_cvqn3c$(this.descriptor, 0, this.keySerializer_0);
          break;
        case 1:
          value_0 = composite.decodeSerializableElement_cvqn3c$(this.descriptor, 1, this.valueSerializer_0);
          break;
        default:
  ...
  TripleSerializer_0.prototype.decodeSequentially_0 = function (composite) {
    var a = composite.decodeSerializableElement_cvqn3c$(this.descriptor, 0, this.aSerializer_0);
    var b = composite.decodeSerializableElement_cvqn3c$(this.descriptor, 1, this.bSerializer_0);
    var c = composite.decodeSerializableElement_cvqn3c$(this.descriptor, 2, this.cSerializer_0);
    composite.endStructure_24f42q$(this.descriptor);
    ...
    mainLoop: while (true) {
      ...
      switch (index) {
        case -1:
          break mainLoop;
        case 0:
          a = composite.decodeSerializableElement_cvqn3c$(this.descriptor, 0, this.aSerializer_0);
          break;
        case 1:
          b = composite.decodeSerializableElement_cvqn3c$(this.descriptor, 1, this.bSerializer_0);
          break;
        case 2:
          c = composite.decodeSerializableElement_cvqn3c$(this.descriptor, 2, this.cSerializer_0);
          break;
        default:
          throw SerializationException_init_0('Unexpected index ' + index);
      }
  ...
  UIntSerializer.prototype.deserialize_bq71mq$ = function (decoder) {
    return new UInt(decoder.decodeInline_24f42q$(this.descriptor).decodeInt());
  };
  ...
  ULongSerializer.prototype.deserialize_bq71mq$ = function (decoder) {
    return new ULong(decoder.decodeInline_24f42q$(this.descriptor).decodeLong());
  };
  ...
  UByteSerializer.prototype.deserialize_bq71mq$ = function (decoder) {
    return new UByte(decoder.decodeInline_24f42q$(this.descriptor).decodeByte());
  };
  ...
  UShortSerializer.prototype.deserialize_bq71mq$ = function (decoder) {
    return new UShort(decoder.decodeInline_24f42q$(this.descriptor).decodeShort());
  };
  ...
  SerialModuleImpl.prototype.getPolymorphic_joiicr$ = function (baseClass, value) {
    ...
    if (!baseClass.isInstance_s8jyv4$(value))
      return null;
  ...
  function SealedClassSerializer(serialName, baseClass, subclasses, subclassSerializers) {
    ...
    this._annotations_0 = emptyList();
    this.descriptor_gganzq$_0 = lazy_0(LazyThreadSafetyMode.PUBLICATION, SealedClassSerializer$descriptor$lambda(serialName, this));
  ...
  function SealedClassSerializer$descriptor$lambda$lambda$lambda(this$SealedClassSerializer) {
    return function ($receiver) {
      var tmp$;
      tmp$ = this$SealedClassSerializer.serialName2Serializer_0.entries.iterator();
      while (tmp$.hasNext()) {
        var element = tmp$.next();
        var name = element.key;
        var serializer = element.value;
        $receiver.element_vxrguq$(name, serializer.descriptor);
      }
      return Unit;
    };
  }
  function SealedClassSerializer$descriptor$lambda$lambda(this$SealedClassSerializer) {
    return function ($receiver) {
      $receiver.element_vxrguq$('type', serializer_8(kotlin_js_internal_StringCompanionObject).descriptor);
      var elementDescriptor = buildSerialDescriptor('kotlinx.serialization.Sealed<' + toString(this$SealedClassSerializer.baseClass.simpleName) + '>', SerialKind$CONTEXTUAL_getInstance(), [], SealedClassSerializer$descriptor$lambda$lambda$lambda(this$SealedClassSerializer));
      $receiver.element_vxrguq$('value', elementDescriptor);
      $receiver.annotations = this$SealedClassSerializer._annotations_0;
      return Unit;
    };
  }
  function SealedClassSerializer$descriptor$lambda(closure$serialName, this$SealedClassSerializer) {
    return function () {
      return buildSerialDescriptor(closure$serialName, PolymorphicKind$SEALED_getInstance(), [], SealedClassSerializer$descriptor$lambda$lambda(this$SealedClassSerializer));
    };
  }
  ...
  var decodeFromString = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-core-js-legacy.kotlinx.serialization.decodeFromString_9hwa22$', wrapFunction(function () {
    ...
    return function (T_0, isT, $receiver, string) {
      var tmp$;
      return $receiver.decodeFromString_c46gy8$(Kotlin.isType(tmp$ = serializer($receiver.serializersModule, getReifiedTypeParameterKType(T_0)), KSerializer) ? tmp$ : throwCCE(), string);
    };
  }));
  ...
  function decodeFromHexString($receiver, deserializer, hex) {
    return $receiver.decodeFromByteArray_j5nm4a$(deserializer, InternalHexConverter_getInstance().parseHexBinary_61zpoe$(hex));
  }
  ...
  var decodeFromHexString_0 = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-core-js-legacy.kotlinx.serialization.decodeFromHexString_d2thiy$', wrapFunction(function () {
    var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
    var decodeFromHexString = _.kotlinx.serialization.decodeFromHexString_v19aby$;
    var serializer = _.kotlinx.serialization.serializer_ca95z9$;
    var KSerializer = _.kotlinx.serialization.KSerializer;
    var throwCCE = Kotlin.throwCCE;
  ...
  var decodeFromByteArray = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-core-js-legacy.kotlinx.serialization.decodeFromByteArray_cbh7ow$', wrapFunction(function () {
    ...
    return function (T_0, isT, $receiver, bytes) {
      var tmp$;
      return $receiver.decodeFromByteArray_j5nm4a$(Kotlin.isType(tmp$ = serializer($receiver.serializersModule, getReifiedTypeParameterKType(T_0)), KSerializer) ? tmp$ : throwCCE(), bytes);
    };
  }));
  ...
  function MissingFieldException_init(missingFields, serialName, $this) {
    $this = $this || Object.create(MissingFieldException.prototype);
    MissingFieldException.call($this, missingFields, missingFields.size === 1 ? "Field '" + missingFields.get_za3lpa$(0) + "' is required for type with serial name '" + serialName + "', but it was missing" : 'Fields ' + missingFields + " are required for type with serial name '" + serialName + "', but they were missing", null);
    return $this;
  }
  function MissingFieldException_init_0(missingField, serialName, $this) {
    $this = $this || Object.create(MissingFieldException.prototype);
  ...
  var serializer_14 = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-core-js-legacy.kotlinx.serialization.serializer_287e2$', wrapFunction(function () {
    var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
    var serializer = _.kotlinx.serialization.serializer_saj79j$;
    var KSerializer = _.kotlinx.serialization.KSerializer;
    var throwCCE = Kotlin.throwCCE;
  ...
  var serializer_15 = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-core-js-legacy.kotlinx.serialization.serializer_3pytt4$', wrapFunction(function () {
    var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
    var serializer = _.kotlinx.serialization.serializer_ca95z9$;
    var KSerializer = _.kotlinx.serialization.KSerializer;
    var throwCCE = Kotlin.throwCCE;
  ...
  function serializer_16(type) {
    return serializer_17(EmptySerializersModule_0(), type);
  }
  function serializerOrNull(type) {
    return serializerOrNull_0(EmptySerializersModule_0(), type);
  }
  function serializer_17($receiver, type) {
    var tmp$;
  ...
  function serializerByKTypeImpl($receiver, type, failOnMissingTypeArgSerializer) {
    ...
    while (tmp$_4.hasNext()) {
      ...
      tmp$_5.call(destination, requireNotNull$result);
    }
    ...
    if (typeArguments.isEmpty()) {
      ...
      if (failOnMissingTypeArgSerializer) {
        ...
        if (cachedResult.isFailure) {
          ...
          getOrNull$result = (tmp$_6 = cachedResult.value) == null || Kotlin.isType(tmp$_6, Any) ? tmp$_6 : throwCCE();
        }
        tmp$ = getOrNull$result;
      } else {
        var tmp$_7, tmp$_0_0;
        var exception = cachedResult.exceptionOrNull();
        if (exception == null)
          tmp$_0_0 = (tmp$_7 = cachedResult.value) == null || Kotlin.isType(tmp$_7, Any) ? tmp$_7 : throwCCE();
        else {
          return null;
        }
        tmp$ = tmp$_0_0;
    ...
    if (typeArguments.isEmpty()) {
      tmp$_2 = $receiver.getContextual_2n2k9f$(rootClass);
    } else {
      tmp$_0 = serializersForParameters($receiver, typeArguments, failOnMissingTypeArgSerializer);
      if (tmp$_0 == null) {
        return null;
      }
      var serializers = tmp$_0;
      tmp$_2 = (tmp$_1 = parametrizedSerializerOrNull(rootClass, typeArguments, serializers)) != null ? tmp$_1 : $receiver.getContextual_2n2k9f$(rootClass, serializers);
    }
    var contextualSerializer = tmp$_2;
    var tmp$_8;
    if (contextualSerializer != null) {
      var tmp$_9;
      tmp$_8 = Kotlin.isType(tmp$_9 = contextualSerializer, KSerializer) ? tmp$_9 : throwCCE();
    } else
      tmp$_8 = null;
    return (tmp$_3 = tmp$_8) != null ? nullable(tmp$_3, isNullable) : null;
  }
  function serializersForParameters($receiver, typeArguments, failOnMissingTypeArgSerializer) {
    var tmp$;
    if (failOnMissingTypeArgSerializer) {
      var destination = ArrayList_init(collectionSizeOrDefault(typeArguments, 10));
      var tmp$_0;
      tmp$_0 = typeArguments.iterator();
      while (tmp$_0.hasNext()) {
        var item = tmp$_0.next();
        destination.add_11rb$(serializer_17($receiver, item));
      }
      tmp$ = destination;
    } else {
      ...
      while (tmp$_1.hasNext()) {
        ...
        var tmp$_3;
        tmp$_3 = serializerOrNull_0($receiver, item_0);
        if (tmp$_3 == null) {
          return null;
        }
        tmp$_2.call(destination_0, tmp$_3);
      }
      tmp$ = destination_0;
    }
    var serializers = tmp$;
  ...
  function parametrizedSerializerOrNull($receiver, types, serializers) {
    var tmp$;
    return (tmp$ = builtinParametrizedSerializer($receiver, types, serializers)) != null ? tmp$ : compiledParametrizedSerializer($receiver, serializers);
  }
  function compiledParametrizedSerializer($receiver, serializers) {
    return constructSerializerForGivenTypeArgs($receiver, copyToArray(serializers).slice());
  }
  function builtinParametrizedSerializer($receiver, typeArguments, serializers) {
    var tmp$, tmp$_0;
    if (equals($receiver, getKClass(Collection)) || equals($receiver, getKClass(List)) || equals($receiver, getKClass(MutableList)) || equals($receiver, getKClass(ArrayList)))
      tmp$_0 = new ArrayListSerializer(serializers.get_za3lpa$(0));
    else if (equals($receiver, getKClass(HashSet)))
      tmp$_0 = new HashSetSerializer(serializers.get_za3lpa$(0));
    else if (equals($receiver, getKClass(Set)) || equals($receiver, getKClass(MutableSet)) || equals($receiver, getKClass(LinkedHashSet)))
      tmp$_0 = new LinkedHashSetSerializer(serializers.get_za3lpa$(0));
    else if (equals($receiver, getKClass(HashMap)))
      tmp$_0 = new HashMapSerializer(serializers.get_za3lpa$(0), serializers.get_za3lpa$(1));
    else if (equals($receiver, getKClass(Map)) || equals($receiver, getKClass(MutableMap)) || equals($receiver, getKClass(LinkedHashMap)))
      tmp$_0 = new LinkedHashMapSerializer(serializers.get_za3lpa$(0), serializers.get_za3lpa$(1));
    else if (equals($receiver, getKClass(Map$Entry)))
      tmp$_0 = MapEntrySerializer(serializers.get_za3lpa$(0), serializers.get_za3lpa$(1));
    else if (equals($receiver, getKClass(Pair)))
      tmp$_0 = PairSerializer(serializers.get_za3lpa$(0), serializers.get_za3lpa$(1));
    else if (equals($receiver, getKClass(Triple)))
      ...
      if (isReferenceArray($receiver)) {
        tmp$_0 = ArraySerializer_0(Kotlin.isType(tmp$ = typeArguments.get_za3lpa$(0).classifier, KClass) ? tmp$ : throwCCE(), serializers.get_za3lpa$(0));
      } else {
        tmp$_0 = null;
      }
    }
  ...
  function noCompiledSerializer(forClass) {
    throw SerializationException_init_0(notRegisteredMessage_0(forClass));
  }
  function noCompiledSerializer_0(module_0, kClass) {
    var tmp$;
    return (tmp$ = module_0.getContextual_2n2k9f$(kClass)) != null ? tmp$ : serializerNotRegistered(kClass);
  }
  function noCompiledSerializer_1(module_0, kClass, argSerializers) {
    var tmp$;
    return (tmp$ = module_0.getContextual_2n2k9f$(kClass, asList(argSerializers))) != null ? tmp$ : serializerNotRegistered(kClass);
  }
  function SERIALIZERS_CACHE$lambda(it) {
    return serializerOrNull_1(it);
  }
  var SERIALIZERS_CACHE;
  function SERIALIZERS_CACHE_NULLABLE$lambda(it) {
    var tmp$, tmp$_0;
    var tmp$_1;
    if ((tmp$_0 = (tmp$ = serializerOrNull_1(it)) != null ? get_nullable(tmp$) : null) != null) {
      var tmp$_2;
      tmp$_1 = Kotlin.isType(tmp$_2 = tmp$_0, KSerializer) ? tmp$_2 : throwCCE();
    } else
      tmp$_1 = null;
    return tmp$_1;
  }
  ...
  function PARAMETRIZED_SERIALIZERS_CACHE_NULLABLE$lambda(clazz, types) {
    ...
    var serializers = ensureNotNull(serializersForParameters(EmptySerializersModule_0(), types, true));
    var tmp$_1;
    if ((tmp$_0 = (tmp$ = parametrizedSerializerOrNull(clazz, types, serializers)) != null ? get_nullable(tmp$) : null) != null) {
      var tmp$_2;
      tmp$_1 = Kotlin.isType(tmp$_2 = tmp$_0, KSerializer) ? tmp$_2 : throwCCE();
    } else
      tmp$_1 = null;
  ...
  function findCachedSerializer(clazz, isNullable) {
    ...
    if (!isNullable) {
      var tmp$_1;
      if ((tmp$ = SERIALIZERS_CACHE.get_suhcqa$(clazz)) != null) {
        var tmp$_2;
      ...
      tmp$_0 = SERIALIZERS_CACHE_NULLABLE.get_suhcqa$(clazz);
    }
    return tmp$_0;
  }
  function findParametrizedCachedSerializer(clazz, types, isNullable) {
    var tmp$, tmp$_0;
    if (!isNullable) {
      tmp$_0 = Kotlin.isType(tmp$ = PARAMETRIZED_SERIALIZERS_CACHE.get_rhihk2$(clazz, types), Result) ? tmp$ : throwCCE();
    } else {
      tmp$_0 = PARAMETRIZED_SERIALIZERS_CACHE_NULLABLE.get_rhihk2$(clazz, types);
    }
    return tmp$_0;
  }
  ...
  function createCache$ObjectLiteral(closure$factory) {
    this.closure$factory = closure$factory;
  }
  createCache$ObjectLiteral.prototype.get_suhcqa$ = function (key) {
    return this.closure$factory(key);
  };
  createCache$ObjectLiteral.$metadata$ = {
    kind: Kind_CLASS,
    interfaces: [SerializerCache]
  };
  function createCache(factory) {
    return new createCache$ObjectLiteral(factory);
  }
  function createParametrizedCache$ObjectLiteral(closure$factory) {
    this.closure$factory = closure$factory;
  }
  createParametrizedCache$ObjectLiteral.prototype.get_rhihk2$$default = function (key, types) {
    this.closure$factory;
    var tmp$;
    try {
      tmp$ = new Result(this.closure$factory(key, types));
    } catch (e) {
  ...
  createParametrizedCache$ObjectLiteral.$metadata$ = {
    kind: Kind_CLASS,
    interfaces: [ParametrizedSerializerCache]
  };
  function createParametrizedCache(factory) {
    return new createParametrizedCache$ObjectLiteral(factory);
  }
  ...
  package$serialization.MetaSerializable = MetaSerializable;
  ...
  package$builtins.serializer_ajevbr$ = serializer_13;
  package$builtins.NothingSerializer = NothingSerializer;
  ...
  package$encoding.ChunkedDecoder = ChunkedDecoder;
  ...
  Object.defineProperty(package$internal, 'DurationSerializer', {
    get: DurationSerializer_getInstance
  });
  Object.defineProperty(package$internal, 'NothingSerializer', {
    get: NothingSerializer_getInstance
  });
  ...
  package$internal.createSimpleEnumSerializer_umj33f$ = createSimpleEnumSerializer;
  package$internal.createMarkedEnumSerializer_fyxh5r$ = createMarkedEnumSerializer;
  package$internal.createAnnotatedEnumSerializer_kdyr5i$ = createAnnotatedEnumSerializer;
  package$internal.EnumSerializer_init_mlrjbz$ = EnumSerializer_init;
  package$internal.EnumSerializer = EnumSerializer;
  package$internal.InlineClassDescriptor = InlineClassDescriptor;
  package$internal.InlinePrimitiveDescriptor_dbyvyc$ = InlinePrimitiveDescriptor;
  ...
  Object.defineProperty(package$internal, 'NothingSerialDescriptor', {
    get: NothingSerialDescriptor_getInstance
  });
  ...
  package$internal.notRegisteredMessage_lu5d9p$ = notRegisteredMessage;
  package$internal.notRegisteredMessage_y4putb$ = notRegisteredMessage_0;
  package$internal.kclass_7v1px$ = kclass;
  package$internal.elementsHashCodeBy_9ua6wn$ = elementsHashCodeBy;
  package$internal.SerializerCache = SerializerCache;
  package$internal.ParametrizedSerializerCache = ParametrizedSerializerCache;
  ...
  Object.defineProperty(package$internal, 'UByteArraySerializer', {
    get: UByteArraySerializer_getInstance
  });
  package$internal.UByteArrayBuilder = UByteArrayBuilder;
  Object.defineProperty(package$internal, 'UShortArraySerializer', {
    get: UShortArraySerializer_getInstance
  });
  package$internal.UShortArrayBuilder = UShortArrayBuilder;
  Object.defineProperty(package$internal, 'UIntArraySerializer', {
    get: UIntArraySerializer_getInstance
  });
  package$internal.UIntArrayBuilder = UIntArrayBuilder;
  Object.defineProperty(package$internal, 'ULongArraySerializer', {
    get: ULongArraySerializer_getInstance
  });
  package$internal.ULongArrayBuilder = ULongArrayBuilder;
  ...
  Object.defineProperty(package$modules, 'EmptySerializersModuleLegacyJs', {
    get: function () {
      return EmptySerializersModule;
    }
  });
  ...
  package$serialization.decodeFromHexString_v19aby$ = decodeFromHexString;
  ...
  package$serialization.MissingFieldException_init_8zkr97$ = MissingFieldException_init;
  package$serialization.MissingFieldException_init_puj7f4$ = MissingFieldException_init_0;
  ...
  package$serialization.serializer_saj79j$ = serializer_16;
  package$serialization.serializer_ca95z9$ = serializer_17;
  ...
  package$serialization.serializersForParameters_s86sag$ = serializersForParameters;
  package$serialization.serializer_1yb8b7$ = serializer_18;
  package$serialization.serializerOrNull_1yb8b7$ = serializerOrNull_1;
  package$serialization.parametrizedSerializerOrNull_p98agt$ = parametrizedSerializerOrNull;
  package$serialization.noCompiledSerializer_61zpoe$ = noCompiledSerializer;
  package$serialization.noCompiledSerializer_vhwd0g$ = noCompiledSerializer_0;
  package$serialization.noCompiledSerializer_pffwfm$ = noCompiledSerializer_1;
  package$serialization.findCachedSerializer_7fr6mu$ = findCachedSerializer;
  package$serialization.findParametrizedCachedSerializer_q1id48$ = findParametrizedCachedSerializer;
  ...
  package$internal.createCache_5kt6kt$ = createCache;
  package$internal.createParametrizedCache_bf8z5g$ = createParametrizedCache;
  ...
  AbstractDecoder.prototype.decodeSerializableValue_2crrky$ = Decoder.prototype.decodeSerializableValue_2crrky$;
  AbstractDecoder.prototype.decodeNullableSerializableValue_h9dkw5$ = Decoder.prototype.decodeNullableSerializableValue_h9dkw5$;
  ...
  AbstractDecoder.prototype.decodeSerializableElement_cvqn3c$ = CompositeDecoder.prototype.decodeSerializableElement_cvqn3c$;
  AbstractDecoder.prototype.decodeNullableSerializableElement_hziakr$ = CompositeDecoder.prototype.decodeNullableSerializableElement_hziakr$;
  ...
  Object.defineProperty(NothingSerialDescriptor.prototype, 'isNullable', Object.getOwnPropertyDescriptor(SerialDescriptor.prototype, 'isNullable'));
  Object.defineProperty(NothingSerialDescriptor.prototype, 'isInline', Object.getOwnPropertyDescriptor(SerialDescriptor.prototype, 'isInline'));
  Object.defineProperty(NothingSerialDescriptor.prototype, 'annotations', Object.getOwnPropertyDescriptor(SerialDescriptor.prototype, 'annotations'));
  ...
  TaggedDecoder.prototype.decodeSerializableValue_2crrky$ = Decoder.prototype.decodeSerializableValue_2crrky$;
  TaggedDecoder.prototype.decodeNullableSerializableValue_h9dkw5$ = Decoder.prototype.decodeNullableSerializableValue_h9dkw5$;
  ...
  TaggedDecoder.prototype.decodeSerializableElement_cvqn3c$ = CompositeDecoder.prototype.decodeSerializableElement_cvqn3c$;
  TaggedDecoder.prototype.decodeNullableSerializableElement_hziakr$ = CompositeDecoder.prototype.decodeNullableSerializableElement_hziakr$;
  ...
  createParametrizedCache$ObjectLiteral.prototype.get_rhihk2$ = ParametrizedSerializerCache.prototype.get_rhihk2$;
