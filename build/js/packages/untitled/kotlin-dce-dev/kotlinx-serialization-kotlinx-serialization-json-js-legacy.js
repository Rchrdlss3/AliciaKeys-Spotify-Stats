(function (root, factory) {
  ...
  var InlinePrimitiveDescriptor = $module$kotlinx_serialization_kotlinx_serialization_core_js_legacy.kotlinx.serialization.internal.InlinePrimitiveDescriptor_dbyvyc$;
  ...
  var constrainOnce = Kotlin.kotlin.sequences.constrainOnce_veqyi0$;
  ...
  var ChunkedDecoder = $module$kotlinx_serialization_kotlinx_serialization_core_js_legacy.kotlinx.serialization.encoding.ChunkedDecoder;
  ...
  DecodeSequenceMode.prototype = Object.create(Enum.prototype);
  DecodeSequenceMode.prototype.constructor = DecodeSequenceMode;
  ...
  ComposerForUnquotedLiterals.prototype = Object.create(Composer_0.prototype);
  ComposerForUnquotedLiterals.prototype.constructor = ComposerForUnquotedLiterals;
  ...
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral.prototype = Object.create(AbstractEncoder.prototype);
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral.prototype.constructor = AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral;
  AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$ObjectLiteral.prototype = Object.create(AbstractEncoder.prototype);
  AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$ObjectLiteral.prototype.constructor = AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$ObjectLiteral;
  ...
  ReaderJsonLexer.prototype = Object.create(AbstractJsonLexer.prototype);
  ReaderJsonLexer.prototype.constructor = ReaderJsonLexer;
  ...
  Json.prototype.decodeFromString_c46gy8$ = function (deserializer, string) {
    var lexer = new StringJsonLexer(string);
    var input = new StreamingJsonDecoder(this, WriteMode$OBJ_getInstance(), lexer, deserializer.descriptor, null);
    var result = input.decodeSerializableValue_2crrky$(deserializer);
    lexer.expectEof();
    return result;
  };
  ...
  Json.prototype.decodeFromJsonElement_szu4dh$ = function (deserializer, element) {
    return readJson(this, element, deserializer);
  };
  Json.prototype.parseToJsonElement_61zpoe$ = function (string) {
    return this.decodeFromString_c46gy8$(JsonElementSerializer_getInstance(), string);
  };
  Json.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Json',
  ...
  function DecodeSequenceMode(name, ordinal) {
    Enum.call(this);
    this.name$ = name;
    this.ordinal$ = ordinal;
  }
  function DecodeSequenceMode_initFields() {
    DecodeSequenceMode_initFields = function () {
    };
    DecodeSequenceMode$WHITESPACE_SEPARATED_instance = new DecodeSequenceMode('WHITESPACE_SEPARATED', 0);
    DecodeSequenceMode$ARRAY_WRAPPED_instance = new DecodeSequenceMode('ARRAY_WRAPPED', 1);
    DecodeSequenceMode$AUTO_DETECT_instance = new DecodeSequenceMode('AUTO_DETECT', 2);
  }
  var DecodeSequenceMode$WHITESPACE_SEPARATED_instance;
  function DecodeSequenceMode$WHITESPACE_SEPARATED_getInstance() {
    DecodeSequenceMode_initFields();
    return DecodeSequenceMode$WHITESPACE_SEPARATED_instance;
  }
  var DecodeSequenceMode$ARRAY_WRAPPED_instance;
  function DecodeSequenceMode$ARRAY_WRAPPED_getInstance() {
    DecodeSequenceMode_initFields();
    return DecodeSequenceMode$ARRAY_WRAPPED_instance;
  }
  var DecodeSequenceMode$AUTO_DETECT_instance;
  function DecodeSequenceMode$AUTO_DETECT_getInstance() {
    DecodeSequenceMode_initFields();
    return DecodeSequenceMode$AUTO_DETECT_instance;
  }
  DecodeSequenceMode.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'DecodeSequenceMode',
    interfaces: [Enum]
  };
  function DecodeSequenceMode$values() {
    return [DecodeSequenceMode$WHITESPACE_SEPARATED_getInstance(), DecodeSequenceMode$ARRAY_WRAPPED_getInstance(), DecodeSequenceMode$AUTO_DETECT_getInstance()];
  }
  DecodeSequenceMode.values = DecodeSequenceMode$values;
  function DecodeSequenceMode$valueOf(name) {
    switch (name) {
      case 'WHITESPACE_SEPARATED':
        return DecodeSequenceMode$WHITESPACE_SEPARATED_getInstance();
      case 'ARRAY_WRAPPED':
        return DecodeSequenceMode$ARRAY_WRAPPED_getInstance();
      case 'AUTO_DETECT':
        return DecodeSequenceMode$AUTO_DETECT_getInstance();
      default:
        throwISE('No enum constant kotlinx.serialization.json.DecodeSequenceMode.' + name);
    }
  }
  DecodeSequenceMode.valueOf_61zpoe$ = DecodeSequenceMode$valueOf;
  ...
  var decodeFromJsonElement = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-json-js-legacy.kotlinx.serialization.json.decodeFromJsonElement_cmu2rn$', wrapFunction(function () {
    ...
    return function (T_0, isT, $receiver, json) {
      var $receiver_0 = $receiver.serializersModule;
      var tmp$;
      return $receiver.decodeFromJsonElement_szu4dh$(Kotlin.isType(tmp$ = serializer($receiver_0, getReifiedTypeParameterKType(T_0)), KSerializer) ? tmp$ : throwCCE(), json);
    };
  }));
  function JsonBuilder(json) {
    ...
    this.namingStrategy = json.configuration.namingStrategy;
  ...
  JsonContentPolymorphicSerializer.prototype.deserialize_bq71mq$ = function (decoder) {
    ...
    return input.json.decodeFromJsonElement_szu4dh$(actualSerializer, tree);
  };
  ...
  function JsonUnquotedLiteral(value) {
    ...
    else if (equals(value, JsonNull_getInstance().content))
      throw new JsonEncodingException("Creating a literal unquoted value of 'null' is forbidden. If you want to create JSON null literal, use JsonNull object, otherwise, use JsonPrimitive");
    else
      tmp$ = new JsonLiteral(value, false, jsonUnquotedLiteralDescriptor);
    return tmp$;
  }
  var jsonUnquotedLiteralDescriptor;
  function JsonLiteral(body, isString, coerceToInlineType) {
    if (coerceToInlineType === void 0)
      coerceToInlineType = null;
    JsonPrimitive.call(this);
    this.isString_jhh1on$_0 = isString;
    this.coerceToInlineType_8be2vx$ = coerceToInlineType;
    this.content_prrjtz$_0 = body.toString();
    if (this.coerceToInlineType_8be2vx$ != null) {
      if (!this.coerceToInlineType_8be2vx$.isInline) {
  ...
  function put_2($receiver, key, value) {
    return $receiver.put_zafu29$(key, JsonNull_getInstance());
  }
  ...
  function add_2($receiver, value) {
    return $receiver.add_qiw0cd$(JsonNull_getInstance());
  }
  ...
  JsonLiteralSerializer.prototype.serialize_55azsf$ = function (encoder, value) {
    ...
    if (value.coerceToInlineType_8be2vx$ != null) {
      return encoder.encodeInline_24f42q$(value.coerceToInlineType_8be2vx$).encodeString_61zpoe$(value.content);
    }
    if ((tmp$ = get_longOrNull(value)) != null) {
      return encoder.encodeLong_s8cxhz$(tmp$);
    }
    if ((tmp$_0 = toULongOrNull(value.content)) != null) {
      encoder.encodeInline_24f42q$(serializer_0(ULong.Companion).descriptor).encodeLong_s8cxhz$(tmp$_0.data);
      return;
    }
  ...
  function JsonObjectSerializer$JsonObjectDescriptor() {
    ...
    this.$delegate_p32uvu$_0 = MapSerializer(serializer(kotlin_js_internal_StringCompanionObject), JsonElementSerializer_getInstance()).descriptor;
  ...
  function JsonNamingStrategy(f) {
    JsonNamingStrategy$Builtins_getInstance();
    this.function$ = f;
  }
  function JsonNamingStrategy$Builtins() {
    JsonNamingStrategy$Builtins_instance = this;
    this.SnakeCase = new JsonNamingStrategy$Builtins$SnakeCase$ObjectLiteral();
  }
  function JsonNamingStrategy$Builtins$SnakeCase$ObjectLiteral() {
  }
  JsonNamingStrategy$Builtins$SnakeCase$ObjectLiteral.prototype.serialNameForJson_iij8qq$ = function (descriptor, elementIndex, serialName) {
    var $receiver = StringBuilder_init_0(serialName.length * 2 | 0);
    var bufferedChar = {v: null};
    var previousUpperCharsCount = {v: 0};
    var tmp$;
    tmp$ = iterator(serialName);
    while (tmp$.hasNext()) {
      var element = unboxChar(tmp$.next());
      var c = toBoxedChar(element);
      var tmp$_0;
      if (isUpperCase(unboxChar(c))) {
        var tmp$_1 = previousUpperCharsCount.v === 0;
        if (tmp$_1) {
          tmp$_1 = $receiver.length > 0;
        }
        if (tmp$_1 && last($receiver) !== 95)
          $receiver.append_s8itvh$(95);
        if ((tmp$_0 = bufferedChar.v) != null) {
          getCallableRef('append', function ($receiver, p1) {
            return $receiver.append_s8itvh$(unboxChar(p1));
          }.bind(null, $receiver))(tmp$_0);
        }
        previousUpperCharsCount.v = previousUpperCharsCount.v + 1 | 0;
        var $receiver_0 = unboxChar(c);
        bufferedChar.v = String.fromCharCode($receiver_0).toLowerCase().charCodeAt(0);
      } else {
        if (bufferedChar.v != null) {
          if (previousUpperCharsCount.v > 1 && isLetter(unboxChar(c))) {
            $receiver.append_s8itvh$(95);
          }
          $receiver.append_s8jyv4$(toBoxedChar(bufferedChar.v));
          previousUpperCharsCount.v = 0;
          bufferedChar.v = null;
        }
        $receiver.append_s8itvh$(unboxChar(c));
      }
    }
    if (bufferedChar.v != null) {
      $receiver.append_s8jyv4$(toBoxedChar(bufferedChar.v));
  ...
  JsonNamingStrategy$Builtins$SnakeCase$ObjectLiteral.prototype.toString = function () {
    return 'kotlinx.serialization.json.JsonNamingStrategy.SnakeCase';
  };
  JsonNamingStrategy$Builtins$SnakeCase$ObjectLiteral.$metadata$ = {
    kind: Kind_CLASS,
    interfaces: [JsonNamingStrategy]
  };
  JsonNamingStrategy$Builtins.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Builtins',
    interfaces: []
  };
  var JsonNamingStrategy$Builtins_instance = null;
  function JsonNamingStrategy$Builtins_getInstance() {
    if (JsonNamingStrategy$Builtins_instance === null) {
      new JsonNamingStrategy$Builtins();
    }
    return JsonNamingStrategy$Builtins_instance;
  }
  JsonNamingStrategy.prototype.serialNameForJson_iij8qq$ = function (descriptor, elementIndex, serialName) {
    return this.function$(descriptor, elementIndex, serialName);
  };
  JsonNamingStrategy.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'JsonNamingStrategy',
    interfaces: []
  };
  ...
  JsonTransformingSerializer.prototype.deserialize_bq71mq$ = function (decoder) {
    ...
    return input.json.decodeFromJsonElement_szu4dh$(this.tSerializer_nuzucf$_0, this.transformDeserialize_qiw0cd$(element));
  };
  ...
  ComposerForUnquotedLiterals.prototype.printQuoted_61zpoe$ = function (value) {
    if (this.forceQuoting_0)
      Composer_0.prototype.printQuoted_61zpoe$.call(this, value);
    else
      Composer_0.prototype.print_61zpoe$.call(this, value);
  };
  ComposerForUnquotedLiterals.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ComposerForUnquotedLiterals',
    interfaces: [Composer_0]
  };
  ...
  function UnknownKeyException(key, input) {
    return JsonDecodingException_0(-1, "Encountered an unknown key '" + key + "'." + '\n' + "Use 'ignoreUnknownKeys = true' in 'Json {}' builder to ignore unknown keys.\n" + ('Current input: ' + minify(input)));
  }
  ...
  function JsonIterator(mode, json, lexer, deserializer) {
    switch (determineFormat(lexer, mode).name) {
      case 'WHITESPACE_SEPARATED':
        return new JsonIteratorWsSeparated(json, lexer, deserializer);
      case 'ARRAY_WRAPPED':
        return new JsonIteratorArrayWrapped(json, lexer, deserializer);
      case 'AUTO_DETECT':
        throw IllegalStateException_init('AbstractJsonLexer.determineFormat must be called beforehand.'.toString());
      default:
        return Kotlin.noWhenBranchMatched();
    }
  }
  function determineFormat($receiver, suggested) {
    switch (suggested.name) {
      case 'WHITESPACE_SEPARATED':
        return DecodeSequenceMode$WHITESPACE_SEPARATED_getInstance();
      case 'ARRAY_WRAPPED':
        return tryConsumeStartArray($receiver) ? DecodeSequenceMode$ARRAY_WRAPPED_getInstance() : $receiver.fail_8e99oo$(TC_BEGIN_LIST);
      case 'AUTO_DETECT':
        return tryConsumeStartArray($receiver) ? DecodeSequenceMode$ARRAY_WRAPPED_getInstance() : DecodeSequenceMode$WHITESPACE_SEPARATED_getInstance();
      default:
        return Kotlin.noWhenBranchMatched();
    }
  }
  function tryConsumeStartArray($receiver) {
    if ($receiver.peekNextToken() === TC_BEGIN_LIST) {
      $receiver.consumeNextToken_s8j3t7$(TC_BEGIN_LIST);
      return true;
    }
    return false;
  }
  function JsonIteratorWsSeparated(json, lexer, deserializer) {
    this.json_0 = json;
    this.lexer_0 = lexer;
    this.deserializer_0 = deserializer;
  }
  JsonIteratorWsSeparated.prototype.next = function () {
    return (new StreamingJsonDecoder(this.json_0, WriteMode$OBJ_getInstance(), this.lexer_0, this.deserializer_0.descriptor, null)).decodeSerializableValue_2crrky$(this.deserializer_0);
  };
  JsonIteratorWsSeparated.prototype.hasNext = function () {
    return this.lexer_0.isNotEof();
  };
  JsonIteratorWsSeparated.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'JsonIteratorWsSeparated',
    interfaces: [Iterator]
  };
  function JsonIteratorArrayWrapped(json, lexer, deserializer) {
    this.json_0 = json;
    this.lexer_0 = lexer;
    this.deserializer_0 = deserializer;
    this.first_0 = true;
  }
  JsonIteratorArrayWrapped.prototype.next = function () {
    if (this.first_0) {
      this.first_0 = false;
    } else {
      this.lexer_0.consumeNextToken_s8itvh$(COMMA);
    }
    var input = new StreamingJsonDecoder(this.json_0, WriteMode$OBJ_getInstance(), this.lexer_0, this.deserializer_0.descriptor, null);
    return input.decodeSerializableValue_2crrky$(this.deserializer_0);
  };
  JsonIteratorArrayWrapped.prototype.hasNext = function () {
    if (this.lexer_0.peekNextToken() === TC_END_LIST) {
      this.lexer_0.consumeNextToken_s8j3t7$(TC_END_LIST);
      if (this.lexer_0.isNotEof()) {
        if (this.lexer_0.peekNextToken() === TC_BEGIN_LIST)
          this.lexer_0.fail_h6sd2a$('There is a start of the new array after the one parsed to sequence. ' + (DecodeSequenceMode$ARRAY_WRAPPED_getInstance().name + " mode doesn't merge consecutive arrays." + '\n') + ('If you need to parse a stream of arrays, please use ' + DecodeSequenceMode$WHITESPACE_SEPARATED_getInstance().name + ' mode instead.'));
        this.lexer_0.expectEof();
      }
      return false;
    }
    if (!this.lexer_0.isNotEof())
      this.lexer_0.fail_8e99oo$(TC_END_LIST);
    return true;
  };
  JsonIteratorArrayWrapped.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'JsonIteratorArrayWrapped',
    interfaces: [Iterator]
  };
  var JsonDeserializationNamesKey;
  var JsonSerializationNamesKey;
  function buildDeserializationNamesMap$putOrThrow(this$buildDeserializationNamesMap) {
    return function ($receiver, name, index) {
      var tmp$;
      if ((Kotlin.isType(tmp$ = $receiver, Map) ? tmp$ : throwCCE()).containsKey_11rb$(name)) {
        throw new JsonException("The suggested name '" + name + "' for property " + this$buildDeserializationNamesMap.getElementName_za3lpa$(index) + ' is already one of the names for property ' + (this$buildDeserializationNamesMap.getElementName_za3lpa$(getValue($receiver, name)) + ' in ' + this$buildDeserializationNamesMap));
      }
      $receiver.put_xwzc9p$(name, index);
    };
  }
  function buildDeserializationNamesMap($receiver, json) {
    var tmp$, tmp$_0, tmp$_1;
    var putOrThrow = buildDeserializationNamesMap$putOrThrow($receiver);
    var builder = LinkedHashMap_init();
    var strategy = namingStrategy($receiver, json);
    ...
    for (var i = 0; i < tmp$; i++) {
      ...
      if ((tmp$_1 = (tmp$_0 = singleOrNull(destination)) != null ? tmp$_0.names : null) != null) {
        ...
        for (tmp$_3 = 0; tmp$_3 !== tmp$_1.length; ++tmp$_3) {
          ...
          putOrThrow(builder, element_0, i);
        }
      }
      if (strategy != null) {
        putOrThrow(builder, strategy.serialNameForJson_iij8qq$($receiver, i, $receiver.getElementName_za3lpa$(i)), i);
      }
    }
    return builder.isEmpty() ? emptyMap() : builder;
  }
  function deserializationNamesMap$lambda(closure$descriptor, this$deserializationNamesMap) {
    return function () {
      return buildDeserializationNamesMap(closure$descriptor, this$deserializationNamesMap);
    };
  }
  function deserializationNamesMap($receiver, descriptor) {
    return get_schemaCache($receiver).getOrPut_a5unbe$(descriptor, JsonDeserializationNamesKey, deserializationNamesMap$lambda(descriptor, $receiver));
  }
  function serializationNamesIndices$lambda(this$serializationNamesIndices, closure$strategy) {
    return function () {
      var size = this$serializationNamesIndices.elementsCount;
      var array = Array_0(size);
      var tmp$;
      tmp$ = array.length - 1 | 0;
      for (var i = 0; i <= tmp$; i++) {
        var this$serializationNamesIndices_0 = this$serializationNamesIndices;
        var closure$strategy_0 = closure$strategy;
        var baseName = this$serializationNamesIndices_0.getElementName_za3lpa$(i);
        array[i] = closure$strategy_0.serialNameForJson_iij8qq$(this$serializationNamesIndices_0, i, baseName);
      }
      return array;
    };
  }
  function serializationNamesIndices($receiver, json, strategy) {
    return get_schemaCache(json).getOrPut_a5unbe$($receiver, JsonSerializationNamesKey, serializationNamesIndices$lambda($receiver, strategy));
  }
  function getJsonElementName($receiver, json, index) {
    var strategy = namingStrategy($receiver, json);
    return strategy == null ? $receiver.getElementName_za3lpa$(index) : serializationNamesIndices($receiver, json, strategy)[index];
  }
  function namingStrategy($receiver, json) {
    return equals($receiver.kind, StructureKind.CLASS) ? json.configuration.namingStrategy : null;
  }
  function getJsonNameIndex$getJsonNameIndexSlowPath(closure$json, this$getJsonNameIndex, closure$name) {
    return function () {
      var tmp$;
      return (tmp$ = deserializationNamesMap(closure$json, this$getJsonNameIndex).get_11rb$(closure$name)) != null ? tmp$ : -3;
    };
  }
  function getJsonNameIndex($receiver, json, name) {
    var getJsonNameIndexSlowPath = getJsonNameIndex$getJsonNameIndexSlowPath(json, $receiver, name);
    var strategy = namingStrategy($receiver, json);
    if (strategy != null)
  ...
  var tryCoerceValue = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-json-js-legacy.kotlinx.serialization.json.internal.tryCoerceValue_lt1vaf$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
  ...
  SerialReader.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'SerialReader',
    interfaces: []
  };
  ...
  function decodeByReader($receiver, deserializer, reader) {
    var lexer = new ReaderJsonLexer(reader);
    try {
      var input = new StreamingJsonDecoder($receiver, WriteMode$OBJ_getInstance(), lexer, deserializer.descriptor, null);
      var result = input.decodeSerializableValue_2crrky$(deserializer);
      lexer.expectEof();
      return result;
    }finally {
  ...
  function decodeToSequenceByReader$lambda(closure$iter) {
    return function () {
      return closure$iter;
    };
  }
  function decodeToSequenceByReader($receiver, reader, deserializer, format) {
    if (format === void 0)
      format = DecodeSequenceMode$AUTO_DETECT_getInstance();
    var lexer = new ReaderJsonLexer(reader, Kotlin.charArray(16384));
    var iter = JsonIterator(format, $receiver, lexer, deserializer);
    return constrainOnce(new Sequence$ObjectLiteral(decodeToSequenceByReader$lambda(iter)));
  }
  var decodeToSequenceByReader_0 = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-json-js-legacy.kotlinx.serialization.json.internal.decodeToSequenceByReader_asxqzy$', wrapFunction(function () {
    var DecodeSequenceMode = _.kotlinx.serialization.json.DecodeSequenceMode;
    var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
    var decodeToSequenceByReader = _.kotlinx.serialization.json.internal.decodeToSequenceByReader_i2njli$;
    var serializer = _.$$importsForInline$$['kotlinx-serialization-kotlinx-serialization-core-js-legacy'].kotlinx.serialization.serializer_ca95z9$;
    var KSerializer = _.$$importsForInline$$['kotlinx-serialization-kotlinx-serialization-core-js-legacy'].kotlinx.serialization.KSerializer;
    var throwCCE = Kotlin.throwCCE;
    return function (T_0, isT, $receiver, reader, format) {
      if (format === void 0)
        format = DecodeSequenceMode.AUTO_DETECT;
      var $receiver_0 = $receiver.serializersModule;
      var tmp$;
      return decodeToSequenceByReader($receiver, reader, Kotlin.isType(tmp$ = serializer($receiver_0, getReifiedTypeParameterKType(T_0)), KSerializer) ? tmp$ : throwCCE(), format);
    };
  }));
  ...
  function DescriptorSchemaCache() {
    this.map_0 = createMapForCache(16);
  }
  ...
  StreamingJsonDecoder$DiscriminatorHolder.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'DiscriminatorHolder',
    interfaces: []
  };
  ...
  StreamingJsonDecoder.prototype.decodeSerializableValue_2crrky$ = function (deserializer) {
    var tmp$, tmp$_0;
    try {
  ...
  StreamingJsonDecoder.prototype.decodeNotNullMark = function () {
    var tmp$, tmp$_0;
    return !((tmp$_0 = (tmp$ = this.elementMarker_0) != null ? tmp$.isUnmarkedNull_8be2vx$ : null) != null ? tmp$_0 : false) && !this.lexer_8be2vx$.tryConsumeNull_6taknv$();
  };
  ...
  StreamingJsonDecoder.prototype.decodeSerializableElement_cvqn3c$$default = function (descriptor, index, deserializer, previousValue) {
    var isMapKey = this.mode_0 === WriteMode$MAP_getInstance() && (index & 1) === 0;
    if (isMapKey) {
      this.lexer_8be2vx$.path.resetCurrentMapKey();
    }
    var value = this.decodeSerializableElement_cvqn3c$(descriptor, index, deserializer, previousValue, AbstractDecoder.prototype.decodeSerializableElement_cvqn3c$$default.bind(this));
    if (isMapKey) {
  ...
  StreamingJsonDecoder.prototype.coerceInputValue_0 = function (descriptor, index) {
    ...
    tryCoerceValue$break: do {
      ...
      if (tmp$_0) {
        tmp$_0 = this.lexer_8be2vx$.tryConsumeNull_6taknv$(true);
      }
      if (tmp$_0) {
      ...
      if (equals(elementDescriptor.kind, SerialKind.ENUM)) {
        var tmp$_1 = elementDescriptor.isNullable;
        if (tmp$_1) {
          tmp$_1 = this.lexer_8be2vx$.tryConsumeNull_6taknv$(false);
        }
        if (tmp$_1) {
  ...
  StreamingJsonDecoder.prototype.decodeStringChunked_ep0k5p$ = function (consumeChunk) {
    this.lexer_8be2vx$.consumeStringChunked_fqxvek$(this.configuration_0.isLenient, consumeChunk);
  };
  ...
  StreamingJsonDecoder.$metadata$ = {
    ...
    interfaces: [AbstractDecoder, ChunkedDecoder, JsonDecoder]
  };
  function decodeStringToJsonTree($receiver, deserializer, source) {
    var lexer = new StringJsonLexer(source);
    var input = new StreamingJsonDecoder($receiver, WriteMode$OBJ_getInstance(), lexer, deserializer.descriptor, null);
    var tree = input.decodeJsonElement();
    lexer.expectEof();
    return tree;
  ...
  function get_isUnquotedLiteral($receiver) {
    return $receiver.isInline && equals($receiver, jsonUnquotedLiteralDescriptor);
  }
    ...
    switch (this.mode_0.name) {
      ...
      default:
        if (!this.composer_0.writingFirst)
          this.composer_0.print_s8itvh$(COMMA);
        this.composer_0.nextItem();
        this.encodeString_61zpoe$(getJsonElementName(descriptor, this.json, index));
        this.composer_0.print_s8itvh$(COLON);
        this.composer_0.space();
        break;
    }
  ...
  StreamingJsonEncoder.prototype.encodeInline_24f42q$ = function (descriptor) {
    if (get_isUnsignedNumber(descriptor)) {
      return new StreamingJsonEncoder(Kotlin.isType(this.composer_0, ComposerForUnsignedNumbers) ? this.composer_0 : new ComposerForUnsignedNumbers(this.composer_0.writer_8be2vx$, this.forceQuoting_0), this.json, this.mode_0, null);
    } else if (get_isUnquotedLiteral(descriptor)) {
      return new StreamingJsonEncoder(Kotlin.isType(this.composer_0, ComposerForUnquotedLiterals) ? this.composer_0 : new ComposerForUnquotedLiterals(this.composer_0.writer_8be2vx$, this.forceQuoting_0), this.json, this.mode_0, null);
    } else
      return AbstractEncoder.prototype.encodeInline_24f42q$.call(this, descriptor);
  };
  StreamingJsonEncoder.prototype.composerAs_0 = function (T_0, isT, composerCreator) {
    return isT(this.composer_0) ? this.composer_0 : composerCreator(this.composer_0.writer_8be2vx$, this.forceQuoting_0);
  };
  ...
  SuppressAnimalSniffer.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'SuppressAnimalSniffer',
    interfaces: [Annotation]
  };
  function readJson($receiver, element, deserializer) {
    ...
    var input = tmp$_0;
    return input.decodeSerializableValue_2crrky$(deserializer);
  }
  function readPolymorphicJson($receiver, discriminator, element, deserializer) {
    return (new JsonTreeDecoder($receiver, element, discriminator, deserializer.descriptor)).decodeSerializableValue_2crrky$(deserializer);
  }
  ...
  AbstractJsonTreeDecoder.prototype.decodeSerializableValue_2crrky$ = function (deserializer) {
  ...
  JsonTreeDecoder.prototype.coerceInputValue_0 = function (descriptor, index, tag) {
    ...
    tryCoerceValue$break: do {
      ...
      if (equals(elementDescriptor.kind, SerialKind.ENUM)) {
        var tmp$_1 = elementDescriptor.isNullable;
        if (tmp$_1) {
          tmp$_1 = Kotlin.isType(this.currentElement_61zpoe$(tag), JsonNull);
        }
        if (tmp$_1) {
          tryCoerceValue$result = false;
          break tryCoerceValue$break;
        ...
        var tmp$_2, tmp$_3;
        tmp$ = (tmp$_3 = Kotlin.isType(tmp$_2 = this.currentElement_61zpoe$(tag), JsonPrimitive) ? tmp$_2 : null) != null ? get_contentOrNull(tmp$_3) : null;
        if (tmp$ == null) {
          tryCoerceValue$result = false;
          break tryCoerceValue$break;
        }
  ...
  JsonTreeDecoder.prototype.elementName_szpzho$ = function (descriptor, index) {
    var tmp$;
    var strategy = namingStrategy(descriptor, this.json);
    var baseName = descriptor.getElementName_za3lpa$(index);
    if (strategy == null) {
      if (!this.configuration_0.useAlternativeNames)
        return baseName;
      if (this.value.keys.contains_11rb$(baseName))
        return baseName;
    }
    var deserializationNamesMap_0 = deserializationNamesMap(this.json, descriptor);
    ...
    firstOrNull$break: do {
      ...
      while (tmp$_0.hasNext()) {
        ...
        if (deserializationNamesMap_0.get_11rb$(element) === index) {
    ...
    var fallbackName = strategy != null ? strategy.serialNameForJson_iij8qq$(descriptor, index, baseName) : null;
    return fallbackName != null ? fallbackName : baseName;
  };
  ...
  JsonTreeDecoder.prototype.endStructure_24f42q$ = function (descriptor) {
    ...
    if (this.configuration_0.ignoreUnknownKeys || Kotlin.isType(descriptor.kind, PolymorphicKind))
      return;
    var strategy = namingStrategy(descriptor, this.json);
    if (strategy == null && !this.configuration_0.useAlternativeNames)
      tmp$_1 = jsonCachedSerialNames(descriptor);
    else if (strategy != null)
      tmp$_1 = deserializationNamesMap(this.json, descriptor).keys;
    else {
      tmp$_0 = jsonCachedSerialNames(descriptor);
      var $receiver = (tmp$ = get_schemaCache(this.json).get_khmtuq$(descriptor, JsonDeserializationNamesKey)) != null ? tmp$.keys : null;
  ...
  JsonTreeMapDecoder.prototype.elementName_szpzho$ = function (descriptor, index) {
    var i = index / 2 | 0;
  ...
  JsonTreeListDecoder.prototype.elementName_szpzho$ = function (descriptor, index) {
  ...
  AbstractJsonTreeEncoder.prototype.elementName_szpzho$ = function (descriptor, index) {
    return getJsonElementName(descriptor, this.json, index);
  };
  ...
  AbstractJsonTreeEncoder.prototype.encodeTaggedInline_gaombr$ = function (tag, inlineDescriptor) {
    if (get_isUnsignedNumber(inlineDescriptor))
      return this.inlineUnsignedNumberEncoder_0(tag);
    else if (get_isUnquotedLiteral(inlineDescriptor))
      return this.inlineUnquotedLiteralEncoder_0(tag, inlineDescriptor);
    else
      return NamedValueEncoder.prototype.encodeTaggedInline_gaombr$.call(this, tag, inlineDescriptor);
  };
  function AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral(closure$tag, this$AbstractJsonTreeEncoder) {
    this.closure$tag = closure$tag;
    this.this$AbstractJsonTreeEncoder = this$AbstractJsonTreeEncoder;
    AbstractEncoder.call(this);
    this.serializersModule_eartjl$_0 = this$AbstractJsonTreeEncoder.json.serializersModule;
  }
  Object.defineProperty(AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral.prototype, 'serializersModule', {
    configurable: true,
    get: function () {
      return this.serializersModule_eartjl$_0;
    }
  });
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral.prototype.putUnquotedString_61zpoe$ = function (s) {
    this.this$AbstractJsonTreeEncoder.putElement_zafu29$(this.closure$tag, new JsonLiteral(s, false));
  };
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral.prototype.encodeInt_za3lpa$ = function (value) {
    this.putUnquotedString_61zpoe$((new UInt_init(value)).toString());
  };
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral.prototype.encodeLong_s8cxhz$ = function (value) {
    this.putUnquotedString_61zpoe$((new ULong(value)).toString());
  };
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral.prototype.encodeByte_s8j3t7$ = function (value) {
    this.putUnquotedString_61zpoe$((new UByte_init(value)).toString());
  };
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral.prototype.encodeShort_mq22fl$ = function (value) {
    this.putUnquotedString_61zpoe$((new UShort_init(value)).toString());
  };
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral.$metadata$ = {
    kind: Kind_CLASS,
    interfaces: [AbstractEncoder]
  };
  AbstractJsonTreeEncoder.prototype.inlineUnsignedNumberEncoder_0 = function (tag) {
    return new AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral(tag, this);
  };
  function AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$ObjectLiteral(this$AbstractJsonTreeEncoder, closure$tag, closure$inlineDescriptor) {
    this.this$AbstractJsonTreeEncoder = this$AbstractJsonTreeEncoder;
    this.closure$tag = closure$tag;
    this.closure$inlineDescriptor = closure$inlineDescriptor;
    AbstractEncoder.call(this);
  }
  Object.defineProperty(AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$ObjectLiteral.prototype, 'serializersModule', {
    configurable: true,
    get: function () {
      return this.this$AbstractJsonTreeEncoder.json.serializersModule;
    }
  });
  AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$ObjectLiteral.prototype.encodeString_61zpoe$ = function (value) {
    this.this$AbstractJsonTreeEncoder.putElement_zafu29$(this.closure$tag, new JsonLiteral(value, false, this.closure$inlineDescriptor));
  };
  AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$ObjectLiteral.$metadata$ = {
    kind: Kind_CLASS,
    interfaces: [AbstractEncoder]
  };
  AbstractJsonTreeEncoder.prototype.inlineUnquotedLiteralEncoder_0 = function (tag, inlineDescriptor) {
    return new AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$ObjectLiteral(this, tag, inlineDescriptor);
  };
  ...
  AbstractJsonLexer.prototype.tryConsumeNull_6taknv$ = function (doConsume) {
    if (doConsume === void 0)
      doConsume = true;
  ...
  AbstractJsonLexer.prototype.insideString_0 = function (isLenient, char) {
    if (isLenient) {
      return charToTokenClass(char) === TC_OTHER;
    } else {
      return char !== STRING;
    }
  };
  AbstractJsonLexer.prototype.consumeStringChunked_fqxvek$ = function (isLenient, consumeChunk) {
    var nextToken = this.peekNextToken();
    if (isLenient && nextToken !== TC_OTHER)
      return;
    if (!isLenient) {
      this.consumeNextToken_s8itvh$(STRING);
    }
    var currentPosition = this.currentPosition_0;
    var lastPosition = currentPosition;
    var char = this.source.charCodeAt(currentPosition);
    var usedAppend = false;
    while (this.insideString_0(isLenient, char)) {
      ...
      if (currentPosition >= this.source.length) {
        this.writeRange_0(lastPosition, currentPosition, usedAppend, consumeChunk);
        usedAppend = false;
      ...
      char = this.source.charCodeAt(currentPosition);
    }
    this.writeRange_0(lastPosition, currentPosition, usedAppend, consumeChunk);
  ...
  AbstractJsonLexer.prototype.writeRange_0 = function (fromIndex, toIndex, currentChunkHasEscape, consumeChunk) {
    if (currentChunkHasEscape) {
      consumeChunk(this.decodedString_0(fromIndex, toIndex));
    } else {
      consumeChunk(this.substring_vux9f0$(fromIndex, toIndex));
    }
  };
  ...
  function ArrayAsSequence(buffer) {
    this.buffer_0 = buffer;
    this.length_nwndaq$_0 = this.buffer_0.length;
  }
  Object.defineProperty(ArrayAsSequence.prototype, 'length', {
    configurable: true,
    get: function () {
      return this.length_nwndaq$_0;
    },
    set: function (length) {
      this.length_nwndaq$_0 = length;
    }
  });
  ArrayAsSequence.prototype.charCodeAt = function (index) {
    return this.buffer_0[index];
  };
  ArrayAsSequence.prototype.subSequence_vux9f0$ = function (startIndex, endIndex) {
    var tmp$ = this.buffer_0;
    var b = this.length;
    return concatToString(tmp$, startIndex, JsMath.min(endIndex, b));
  };
  ArrayAsSequence.prototype.substring_vux9f0$ = function (startIndex, endIndex) {
    var tmp$ = this.buffer_0;
    var b = this.length;
    return concatToString(tmp$, startIndex, JsMath.min(endIndex, b));
  };
  ArrayAsSequence.prototype.trim_za3lpa$ = function (newSize) {
    var a = this.buffer_0.length;
    this.length = JsMath.min(a, newSize);
  };
  ArrayAsSequence.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ArrayAsSequence',
    interfaces: [CharSequence]
  };
  function ReaderJsonLexer(reader, buffer) {
    if (buffer === void 0)
      buffer = CharArrayPoolBatchSize_getInstance().take();
    AbstractJsonLexer.call(this);
    this.reader_0 = reader;
    this.buffer_0 = buffer;
    this.threshold_0 = 128;
    this.source_u10a4u$_0 = new ArrayAsSequence(this.buffer_0);
    this.preload_0(0);
  }
  Object.defineProperty(ReaderJsonLexer.prototype, 'source', {
    configurable: true,
    get: function () {
      return this.source_u10a4u$_0;
    }
  });
  ReaderJsonLexer.prototype.tryConsumeComma = function () {
    var current = this.skipWhitespaces();
    if (current >= this.source.length || current === -1)
      return false;
  ...
  ReaderJsonLexer.prototype.canConsumeValue = function () {
    this.ensureHaveChars();
    var current = this.currentPosition_0;
    while (true) {
      current = this.prefetchOrEof_za3lpa$(current);
  ...
  ReaderJsonLexer.prototype.preload_0 = function (unprocessedCount) {
    var buffer = this.source.buffer_0;
    if (unprocessedCount !== 0) {
      arrayCopy(buffer, buffer, 0, this.currentPosition_0, this.currentPosition_0 + unprocessedCount | 0);
    }
    var filledCount = unprocessedCount;
    var sizeTotal = this.source.length;
    while (filledCount !== sizeTotal) {
      var actual = this.reader_0.read_8chfmy$(buffer, filledCount, sizeTotal - filledCount | 0);
      if (actual === -1) {
        this.source.trim_za3lpa$(filledCount);
        this.threshold_0 = -1;
        break;
      }
      filledCount = filledCount + actual | 0;
    }
    this.currentPosition_0 = 0;
  };
  ReaderJsonLexer.prototype.prefetchOrEof_za3lpa$ = function (position) {
    if (position < this.source.length)
      return position;
    this.currentPosition_0 = position;
    this.ensureHaveChars();
    var tmp$ = this.currentPosition_0 !== 0;
    if (!tmp$) {
      tmp$ = this.source.length === 0;
    }
    if (tmp$)
      return -1;
    return 0;
  };
  ReaderJsonLexer.prototype.consumeNextToken = function () {
    var tmp$, tmp$_0;
    this.ensureHaveChars();
    var source = this.source;
    var cpos = this.currentPosition_0;
    while (true) {
      ...
      if (cpos === -1)
        break;
      var ch = source.charCodeAt((tmp$ = cpos, cpos = tmp$ + 1 | 0, tmp$));
  ...
  ReaderJsonLexer.prototype.ensureHaveChars = function () {
    var cur = this.currentPosition_0;
    var oldSize = this.source.length;
    var spaceLeft = oldSize - cur | 0;
    if (spaceLeft > this.threshold_0)
      return;
    this.preload_0(spaceLeft);
  };
  ReaderJsonLexer.prototype.consumeKeyString = function () {
    this.consumeNextToken_s8itvh$(STRING);
    var current = this.currentPosition_0;
    var closingQuote = this.indexOf_s9u7hn$(34, current);
    if (closingQuote === -1) {
      current = this.prefetchOrEof_za3lpa$(current);
      if (current === -1)
        this.fail_8e99oo$(TC_STRING);
      else
        return this.consumeString2(this.source, this.currentPosition_0, current);
    }
    ...
    return this.substring_vux9f0$(current, closingQuote);
  };
  ReaderJsonLexer.prototype.indexOf_s9u7hn$ = function (char, startPos) {
    var tmp$;
    var src = this.source;
    tmp$ = src.length;
    for (var i = startPos; i < tmp$; i++) {
      if (src.charCodeAt(i) === char)
        return i;
    }
    return -1;
  };
  ReaderJsonLexer.prototype.substring_vux9f0$ = function (startPos, endPos) {
    return this.source.substring_vux9f0$(startPos, endPos);
  };
  ReaderJsonLexer.prototype.appendRange_vux9f0$ = function (fromIndex, toIndex) {
    this.escapedString_0.appendRange_8chfmy$(this.source.buffer_0, fromIndex, toIndex);
  };
  ReaderJsonLexer.prototype.consumeLeadingMatchingValue_ivxn3r$ = function (keyToMatch, isLenient) {
    return null;
  };
  ReaderJsonLexer.prototype.release = function () {
    CharArrayPoolBatchSize_getInstance().release_4hbowm$(this.buffer_0);
  };
  ReaderJsonLexer.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ReaderJsonLexer',
  ...
  StringJsonLexer.prototype.consumeStringChunked_fqxvek$ = function (isLenient, consumeChunk) {
    var tmp$;
    tmp$ = chunked(isLenient ? this.consumeStringLenient() : this.consumeString(), 16384).iterator();
    while (tmp$.hasNext()) {
  ...
  var decodeFromDynamic_0 = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-json-js-legacy.kotlinx.serialization.json.decodeFromDynamic_is5yld$', wrapFunction(function () {
    var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
    var decodeFromDynamic = _.kotlinx.serialization.json.decodeFromDynamic_ryvai1$;
    var serializer = _.$$importsForInline$$['kotlinx-serialization-kotlinx-serialization-core-js-legacy'].kotlinx.serialization.serializer_ca95z9$;
    var KSerializer = _.$$importsForInline$$['kotlinx-serialization-kotlinx-serialization-core-js-legacy'].kotlinx.serialization.KSerializer;
    var throwCCE = Kotlin.throwCCE;
  ...
  function CharArrayPoolBatchSize() {
    CharArrayPoolBatchSize_instance = this;
  }
  CharArrayPoolBatchSize.prototype.take = function () {
    return Kotlin.charArray(16384);
  };
  CharArrayPoolBatchSize.prototype.release_4hbowm$ = function (array) {
  };
  CharArrayPoolBatchSize.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'CharArrayPoolBatchSize',
    interfaces: []
  };
  var CharArrayPoolBatchSize_instance = null;
  function CharArrayPoolBatchSize_getInstance() {
    if (CharArrayPoolBatchSize_instance === null) {
      new CharArrayPoolBatchSize();
    }
    return CharArrayPoolBatchSize_instance;
  }
  ...
  DynamicInput.prototype.decodeSerializableValue_2crrky$ = function (deserializer) {
    return decodeSerializableValuePolymorphic(this, deserializer);
  };
  DynamicInput.prototype.coerceInputValue_0 = function (descriptor, index, tag) {
    ...
    tryCoerceValue$break: do {
      ...
      if (equals(elementDescriptor.kind, SerialKind.ENUM)) {
        var tmp$_1 = elementDescriptor.isNullable;
        if (tmp$_1) {
          tmp$_1 = this.getByTag_61zpoe$(tag) == null;
        }
        if (tmp$_1) {
          tryCoerceValue$result = false;
          break tryCoerceValue$break;
        ...
        var tmp$_2;
        tmp$ = typeof (tmp$_2 = this.getByTag_61zpoe$(tag)) === 'string' ? tmp$_2 : null;
        if (tmp$ == null) {
          tryCoerceValue$result = false;
          break tryCoerceValue$break;
        }
  ...
  DynamicInput.prototype.elementName_szpzho$ = function (descriptor, index) {
    var tmp$, tmp$_0;
    var strategy = namingStrategy(descriptor, this.json);
    var mainName = descriptor.getElementName_za3lpa$(index);
    if (strategy == null) {
    ...
    var fallbackName = strategy != null ? strategy.serialNameForJson_iij8qq$(descriptor, index, mainName) : null;
    return fallbackName != null ? fallbackName : mainName;
  };
  ...
  Object.defineProperty(DynamicMapInput.prototype, 'isKey_0', {
    configurable: true,
    get: function () {
      return (this.currentPosition_1 % 2 | 0) === 0;
    }
  });
  DynamicMapInput.prototype.elementName_szpzho$ = function (descriptor, index) {
    var tmp$;
    var i = index / 2 | 0;
  ...
  DynamicMapInput.prototype.getByTag_61zpoe$ = function (tag) {
    return (this.currentPosition_1 % 2 | 0) === 0 ? tag : this.value_0[tag];
  };
  ...
  DynamicListInput.prototype.elementName_szpzho$ = function (descriptor, index) {
    return index.toString();
  };
  ...
  DynamicObjectEncoder.prototype.encodeElement_szpzho$ = function (descriptor, index) {
    ...
    if (this.current_0.writeMode === DynamicObjectEncoder$WriteMode$MAP_getInstance())
      this.currentElementIsMapKey_0 = (this.current_0.index % 2 | 0) === 0;
      ...
      this.currentName_0 = getJsonElementName(descriptor, this.json, index);
    return true;
  };
  ...
  DynamicPrimitiveEncoder.prototype.encodeLong_s8cxhz$ = function (value) {
    ...
    if (!this.json.configuration.isLenient && abs(value).toNumber() > MAX_SAFE_INTEGER) {
      throw IllegalArgumentException_init(value.toString() + " can't be deserialized to number due to a potential precision loss. " + 'Use the JsonConfiguration option isLenient to serialize anyway');
    }
    this.encodeValue_za3rmp$(asDouble);
  };
  ...
  JsonToStringWriter.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'JsonToStringWriter',
  ...
  Object.defineProperty(DecodeSequenceMode, 'WHITESPACE_SEPARATED', {
    get: DecodeSequenceMode$WHITESPACE_SEPARATED_getInstance
  });
  Object.defineProperty(DecodeSequenceMode, 'ARRAY_WRAPPED', {
    get: DecodeSequenceMode$ARRAY_WRAPPED_getInstance
  });
  Object.defineProperty(DecodeSequenceMode, 'AUTO_DETECT', {
    get: DecodeSequenceMode$AUTO_DETECT_getInstance
  });
  package$json.DecodeSequenceMode = DecodeSequenceMode;
  ...
  package$json.JsonPrimitive_8u77gh$ = JsonPrimitive_3;
  package$json.JsonUnquotedLiteral_pdl1vj$ = JsonUnquotedLiteral;
  Object.defineProperty(package$json, 'jsonUnquotedLiteralDescriptor_8be2vx$', {
    get: function () {
  ...
  Object.defineProperty(JsonNamingStrategy, 'Builtins', {
    get: JsonNamingStrategy$Builtins_getInstance
  });
  package$json.JsonNamingStrategy = JsonNamingStrategy;
  ...
  package$internal.ComposerForUnquotedLiterals = ComposerForUnquotedLiterals;
  ...
  package$internal.JsonIterator_4uf2au$ = JsonIterator;
  Object.defineProperty(package$internal, 'JsonDeserializationNamesKey_8be2vx$', {
    get: function () {
      return JsonDeserializationNamesKey;
    }
  });
  Object.defineProperty(package$internal, 'JsonSerializationNamesKey_8be2vx$', {
    get: function () {
      return JsonSerializationNamesKey;
    }
  });
  package$internal.deserializationNamesMap_q3nfcb$ = deserializationNamesMap;
  package$internal.serializationNamesIndices_anzidr$ = serializationNamesIndices;
  package$internal.getJsonElementName_gprpdx$ = getJsonElementName;
  package$internal.namingStrategy_b4b1k9$ = namingStrategy;
  ...
  package$internal.tryCoerceValue_lt1vaf$ = tryCoerceValue;
  package$internal.JsonPath = JsonPath;
  package$internal.JsonWriter = JsonWriter;
  package$internal.SerialReader = SerialReader;
  package$internal.encodeByWriter_12q8ao$ = encodeByWriter;
  package$internal.decodeByReader_5v3gj3$ = decodeByReader;
  package$internal.decodeToSequenceByReader_i2njli$ = decodeToSequenceByReader;
  ...
  package$internal.decodeSerializableValuePolymorphic_n9dc3b$ = decodeSerializableValuePolymorphic;
  ...
  package$internal.decodeStringToJsonTree_26y462$ = decodeStringToJsonTree;
  ...
  package$internal.get_isUnquotedLiteral_tie8r4$ = get_isUnquotedLiteral;
  ...
  Object.defineProperty(package$internal, 'ESCAPE_STRINGS', {
    get: function () {
  ...
  package$internal.SuppressAnimalSniffer = SuppressAnimalSniffer;
  package$internal.readJson_ycbxcb$ = readJson;
  package$internal.readPolymorphicJson_mn22wn$ = readPolymorphicJson;
  ...
  Object.defineProperty(package$internal, 'BATCH_SIZE', {
    get: function () {
      return BATCH_SIZE;
    }
  });
  package$internal.ArrayAsSequence = ArrayAsSequence;
  package$internal.ReaderJsonLexer = ReaderJsonLexer;
  package$internal.StringJsonLexer = StringJsonLexer;
  package$json.decodeFromDynamic_ryvai1$ = decodeFromDynamic;
  package$json.encodeToDynamic_9ibeu3$ = encodeToDynamic;
  package$json.get_schemaCache_sawd1p$ = get_schemaCache;
  Object.defineProperty(package$internal, 'CharArrayPoolBatchSize', {
    get: CharArrayPoolBatchSize_getInstance
  });
  ...
  JsonDecoder.prototype.decodeNullableSerializableValue_h9dkw5$ = Decoder.prototype.decodeNullableSerializableValue_h9dkw5$;
  JsonDecoder.prototype.decodeSerializableValue_2crrky$ = Decoder.prototype.decodeSerializableValue_2crrky$;
  ...
  JsonDecoder.prototype.decodeNullableSerializableElement_hziakr$ = CompositeDecoder.prototype.decodeNullableSerializableElement_hziakr$;
  JsonDecoder.prototype.decodeSerializableElement_cvqn3c$ = CompositeDecoder.prototype.decodeSerializableElement_cvqn3c$;
  ...
  StreamingJsonDecoder.prototype.decodeNullableSerializableValue_h9dkw5$ = JsonDecoder.prototype.decodeNullableSerializableValue_h9dkw5$;
  ...
  jsonUnquotedLiteralDescriptor = InlinePrimitiveDescriptor('kotlinx.serialization.json.JsonUnquotedLiteral', serializer(kotlin_js_internal_StringCompanionObject));
  JsonDeserializationNamesKey = new DescriptorSchemaCache$Key();
  JsonSerializationNamesKey = new DescriptorSchemaCache$Key();
  unsignedNumberDescriptors = setOf([serializer_1(UInt_init.Companion).descriptor, serializer_0(ULong.Companion).descriptor, serializer_2(UByte_init.Companion).descriptor, serializer_3(UShort_init.Companion).descriptor]);
