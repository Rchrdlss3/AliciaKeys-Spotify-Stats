(function (root, factory) {
  ...
  ComposerForUnquotedLiterals.$metadata$ = {kind: Kind_CLASS, simpleName: 'ComposerForUnquotedLiterals', interfaces: [Composer_0]};
  ...
  StreamingJsonDecoder.$metadata$ = {kind: Kind_CLASS, simpleName: 'StreamingJsonDecoder', interfaces: [AbstractDecoder, ChunkedDecoder, JsonDecoder]};
  ...
  Object.defineProperty(AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral.prototype, 'serializersModule', {configurable: true, get: function () {
  ...
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$ObjectLiteral.$metadata$ = {kind: Kind_CLASS, interfaces: [AbstractEncoder]};
  ...
  Object.defineProperty(AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$ObjectLiteral.prototype, 'serializersModule', {configurable: true, get: function () {
  ...
  AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$ObjectLiteral.$metadata$ = {kind: Kind_CLASS, interfaces: [AbstractEncoder]};
