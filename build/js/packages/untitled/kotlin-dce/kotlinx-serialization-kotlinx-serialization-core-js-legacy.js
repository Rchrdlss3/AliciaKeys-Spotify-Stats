(function (root, factory) {
  ...
  ChunkedDecoder.$metadata$ = {kind: Kind_INTERFACE, simpleName: 'ChunkedDecoder', interfaces: []};
  function Decoder() {
  }
  ...
  Object.defineProperty(NothingSerializer_0.prototype, 'descriptor', {configurable: true, get: function () {
  ...
  NothingSerializer_0.$metadata$ = {kind: Kind_OBJECT, simpleName: 'NothingSerializer', interfaces: [KSerializer]};
  ...
  Object.defineProperty(NothingSerialDescriptor.prototype, 'kind', {configurable: true, get: function () {
    return this.kind_euvy30$_0;
  }});
  Object.defineProperty(NothingSerialDescriptor.prototype, 'serialName', {configurable: true, get: function () {
    return this.serialName_p4df4v$_0;
  }});
  Object.defineProperty(NothingSerialDescriptor.prototype, 'elementsCount', {configurable: true, get: function () {
    return 0;
  }});
  ...
  NothingSerialDescriptor.$metadata$ = {kind: Kind_OBJECT, simpleName: 'NothingSerialDescriptor', interfaces: [SerialDescriptor]};
  ...
  SerializerCache.$metadata$ = {kind: Kind_INTERFACE, simpleName: 'SerializerCache', interfaces: []};
  ...
  ParametrizedSerializerCache.$metadata$ = {kind: Kind_INTERFACE, simpleName: 'ParametrizedSerializerCache', interfaces: []};
  ...
  UByteArraySerializer_0.$metadata$ = {kind: Kind_OBJECT, simpleName: 'UByteArraySerializer', interfaces: [PrimitiveArraySerializer, KSerializer]};
  ...
  Object.defineProperty(UByteArrayBuilder.prototype, 'position', {configurable: true, get: function () {
  ...
  UByteArrayBuilder.$metadata$ = {kind: Kind_CLASS, simpleName: 'UByteArrayBuilder', interfaces: [PrimitiveArrayBuilder]};
  ...
  UShortArraySerializer_0.$metadata$ = {kind: Kind_OBJECT, simpleName: 'UShortArraySerializer', interfaces: [PrimitiveArraySerializer, KSerializer]};
  ...
  Object.defineProperty(UShortArrayBuilder.prototype, 'position', {configurable: true, get: function () {
  ...
  UShortArrayBuilder.$metadata$ = {kind: Kind_CLASS, simpleName: 'UShortArrayBuilder', interfaces: [PrimitiveArrayBuilder]};
  ...
  UIntArraySerializer_0.$metadata$ = {kind: Kind_OBJECT, simpleName: 'UIntArraySerializer', interfaces: [PrimitiveArraySerializer, KSerializer]};
  ...
  Object.defineProperty(UIntArrayBuilder.prototype, 'position', {configurable: true, get: function () {
  ...
  UIntArrayBuilder.$metadata$ = {kind: Kind_CLASS, simpleName: 'UIntArrayBuilder', interfaces: [PrimitiveArrayBuilder]};
  ...
  ULongArraySerializer_0.$metadata$ = {kind: Kind_OBJECT, simpleName: 'ULongArraySerializer', interfaces: [PrimitiveArraySerializer, KSerializer]};
  ...
  Object.defineProperty(ULongArrayBuilder.prototype, 'position', {configurable: true, get: function () {
  ...
  ULongArrayBuilder.$metadata$ = {kind: Kind_CLASS, simpleName: 'ULongArrayBuilder', interfaces: [PrimitiveArrayBuilder]};
  ...
  createCache$ObjectLiteral.$metadata$ = {kind: Kind_CLASS, interfaces: [SerializerCache]};
  ...
  createParametrizedCache$ObjectLiteral.$metadata$ = {kind: Kind_CLASS, interfaces: [ParametrizedSerializerCache]};
  ...
  Object.defineProperty(package$internal, 'NothingSerializer', {get: NothingSerializer_getInstance});
  ...
  Object.defineProperty(package$internal, 'NothingSerialDescriptor', {get: NothingSerialDescriptor_getInstance});
  ...
  Object.defineProperty(package$internal, 'UByteArraySerializer', {get: UByteArraySerializer_getInstance});
  package$internal.UByteArrayBuilder = UByteArrayBuilder;
  Object.defineProperty(package$internal, 'UShortArraySerializer', {get: UShortArraySerializer_getInstance});
  package$internal.UShortArrayBuilder = UShortArrayBuilder;
  Object.defineProperty(package$internal, 'UIntArraySerializer', {get: UIntArraySerializer_getInstance});
  package$internal.UIntArrayBuilder = UIntArrayBuilder;
  Object.defineProperty(package$internal, 'ULongArraySerializer', {get: ULongArraySerializer_getInstance});
